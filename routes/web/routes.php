...
Route::group(['namespace' => 'Customer', 'prefix' => 'customer', 'as' => 'customer.'], function () {
    ...
    Route::group(['namespace' => 'Auth', 'prefix' => 'auth', 'as' => 'auth.'], function () {
        ...
        Route::post('subscribe', 'RegisterController@subscribe')->name('subscribe');
...
// routes/web.php
Route::post('/subscribe', [MagzineProductController::class, 'subscribe'])->name('vendor.magzineproducts.subscribe');
