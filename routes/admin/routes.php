...
use App\Enums\ViewPaths\Admin\PrimeMember;
...
use App\Http\Controllers\Admin\Prime\PrimeController;
...
use App\Enums\ViewPaths\Admin\MagzineProduct;
...
use App\Http\Controllers\Admin\PrimeMember\PrimeMemberController;
...
use App\Http\Controllers\Admin\Vendor\MagzineVendorController;
use App\Http\Controllers\Admin\Vendor\HandmadeVendorController;
use App\Http\Controllers\Admin\Product\ReviewController;
use App\Http\Controllers\Admin\Product\ProductController;
use App\Http\Controllers\Admin\Product\MagzineProductController;
use App\Http\Controllers\Admin\Product\CategoryController;
use App\Http\Controllers\Admin\Product\MagzineCategoryController;
use App\Http\Controllers\Admin\Product\MagzineSubCategoryController;
...
Route::group(['prefix' => 'magzineproducts', 'as' => 'magzineproducts.', 'middleware' => ['module:product_management']], function () {
        Route::controller(MagzineProductController::class)->group(function () {
            Route::get(MagzineProduct::LIST[URI] . '/{type}', 'index')->name('list');
            Route::get(MagzineProduct::ADD[URI], 'getAddView')->name('add');
            Route::post(MagzineProduct::ADD[URI], 'add')->name('store');
            Route::get(MagzineProduct::VIEW[URI].'/{addedBy}/{id}', 'getView')->name('view');
            Route::post(MagzineProduct::SKU_COMBINATION[URI], 'getSkuCombinationView')->name('sku-combination');
            Route::post(MagzineProduct::FEATURED_STATUS[URI], 'updateFeaturedStatus')->name('featured-status');
            Route::get(MagzineProduct::GET_CATEGORIES[URI], 'getCategories')->name('get-categories');
            Route::post(MagzineProduct::UPDATE_STATUS[URI], 'updateStatus')->name('status-update');
            Route::get(MagzineProduct::BARCODE_VIEW[URI] . '/{id}', 'getBarcodeView')->name('barcode');
            Route::get(MagzineProduct::EXPORT_EXCEL[URI] . '/{type}', 'exportList')->name('export-excel');
            Route::get(MagzineProduct::STOCK_LIMIT[URI] . '/{type}', 'getStockLimitListView')->name('stock-limit-list');
            Route::delete(MagzineProduct::DELETE[URI] . '/{id}', 'delete')->name('delete');
            Route::get(MagzineProduct::UPDATE[URI] . '/{id}', 'getUpdateView')->name('update');
            Route::post(MagzineProduct::UPDATE[URI] . '/{id}', 'update');
            Route::get(MagzineProduct::DELETE_IMAGE[URI], 'deleteImage')->name('delete-image');
            Route::get(MagzineProduct::GET_VARIATIONS[URI], 'getVariations')->name('get-variations');
            Route::post(MagzineProduct::UPDATE_QUANTITY[URI], 'updateQuantity')->name('update-quantity');
            Route::get(MagzineProduct::BULK_IMPORT[URI], 'getBulkImportView')->name('bulk-import');
            Route::post(MagzineProduct::BULK_IMPORT[URI], 'importBulkProduct');
            Route::get(magzineProduct::UPDATED_PRODUCT_LIST[URI], 'updatedProductList')->name('updated-product-list');
            Route::post(MagzineProduct::UPDATED_SHIPPING[URI], 'updatedShipping')->name('updated-shipping');
            Route::post(MagzineProduct::DENY[URI], 'deny')->name('deny');
            Route::post(MagzineProduct::APPROVE_STATUS[URI], 'approveStatus')->name('approve-status');
            Route::get(MagzineProduct::SEARCH[URI], 'getSearchedProductsView')->name('search-product');
        });
    });
   ...
   // Category
    Route::group(['prefix' => 'magzinecategory', 'as' => 'magzinecategory.','middleware'=>['module:product_management']], function () {
        Route::controller(MagzineCategoryController::class)->group(function (){
            Route::get(MagzineCategory::LIST[URI], 'index')->name('magzineview');
            Route::post(MagzineCategory::ADD[URI], 'add')->name('store');
            Route::get(MagzineCategory::UPDATE[URI], 'getUpdateView')->name('update');
            Route::post(MagzineCategory::UPDATE[URI], 'update');
            Route::post(MagzineCategory::DELETE[URI], 'delete')->name('delete');
            Route::post(MagzineCategory::STATUS[URI], 'updateStatus')->name('status');
            Route::get(MagzineCategory::EXPORT[URI], 'getExportList')->name('export');
    ...
    Route::group(['prefix' => 'sub-category', 'as' => 'sub-category.','middleware'=>['module:product_management']], function () {
     ...
     // SUB Category
     Route::group(['prefix' => 'magzinesubcategory', 'as' => 'magzinesubcategory.','middleware'=>['module:product_management']], function () {
        Route::controller(MagzineSubCategoryController::class)->group(function (){
            Route::get(MagzineSubCategory::LIST[URI], 'index')->name('view');
            Route::post(MagzineSubCategory::ADD[URI], 'add')->name('store');
            Route::get(MagzineSubCategory::UPDATE[URI], 'getUpdateView')->name('update');
            Route::post(MagzineSubCategory::UPDATE[URI], 'update');
            Route::post(MagzineSubCategory::DELETE[URI], 'delete')->name('delete');
            Route::post(MagzineSubCategory::STATUS[URI], 'updateStatus')->name('status');
            Route::get(MagzineSubCategory::EXPORT[URI], 'getExportList')->name('export');
 ...
 // Prime
    Route::group(['prefix' => 'prime', 'as' => 'prime.','middleware'=>['module:']], function () {
        Route::controller(PrimeController::class)->group(function (){
            Route::get(Banner::LIST[URI], 'index')->name('list');
            Route::post(Banner::ADD[URI], 'add')->name('store');
            Route::post(Banner::DELETE[URI], 'delete')->name('delete');
            Route::post(Banner::STATUS[URI], 'updateStatus')->name('status');
...
Route::group(['prefix' => 'primemember', 'as' => 'primemember.','middleware'=>['module:']], function () {
        Route::controller(PrimeMemberController::class)->group(function (){
            Route::get(PrimeMember::LIST[URI], 'getListView')->name('list');
            Route::get(PrimeMember::VIEW[URI].'/{primemember_id}', 'getView')->name('view');

            Route::get(PrimeMember::SEARCH[URI],'getPrimeMemberList')->name('primemember-list-search');
    ...
    Route::group(['prefix' => 'sellers', 'as' => 'sellers.','middleware'=>['module:user_section']], function () {
        Route::controller(VendorController::class)->group(function (){
            ...
            // Route::get(MagzineVendor::LIST[URI], 'index')->name('magzineseller-list');
            // Route::get(HandmadeVendor::LIST[URI], 'index')->name('handmadeseller-list');
            ...
            Route::post(Vendor::DOCSTATUS[URI], 'updateDocStatus')->name('updateDocStatus');
            Route::post(Vendor::COMMISIONSTATUS[URI], 'updateCommissionStatus')->name('updateCommissionStatus');
...
Route::group(['prefix' => 'handmadesellers', 'as' => 'handmadesellers.','middleware'=>['module:user_section']], function () {
        Route::controller(HandmadeVendorController::class)->group(function (){
            Route::get(HandmadeVendor::LIST[URI], 'index')->name('seller-list');

            // Route::get(MagzineHandmadeVendor::LIST[URI], 'index')->name('magzineseller-list');
            // Route::get(HandmadeHandmadeVendor::LIST[URI], 'index')->name('handmadeseller-list');



            Route::get(HandmadeVendor::ADD[URI], 'getAddView')->name('add');
            Route::POST(HandmadeVendor::ADD[URI], 'add');
            Route::get(HandmadeVendor::ORDER_LIST[URI].'/{seller_id}', 'getOrderListView')->name('order-list');
            Route::post(HandmadeVendor::STATUS[URI], 'updateStatus')->name('updateStatus');
            Route::post(HandmadeVendor::DOCSTATUS[URI], 'updateDocStatus')->name('updateDocStatus');

            Route::post(HandmadeVendor::updateCommissionStatus[URI], 'updateCommissionStatus')->name('updateCommissionStatus');


            Route::get(HandmadeVendor::EXPORT[URI], 'exportList')->name('export');
            Route::get(HandmadeVendor::PRODUCT_LIST[URI].'/{seller_id}', 'getProductListView')->name('product-list');

            Route::post(HandmadeVendor::SALES_COMMISSION_UPDATE[URI].'/{id}', 'updateSalesCommission')->name('sales-commission-update');
            Route::get(HandmadeVendor::ORDER_DETAILS[URI].'/{order_id}/{seller_id}', 'getOrderDetailsView')->name('order-details');
            Route::get(HandmadeVendor::VIEW[URI].'/{id}/{tab?}', 'getView')->name('view');
            Route::post(HandmadeVendor::UPDATE_SETTING[URI].'/{id}', 'updateSetting')->name('update-setting');

            Route::get(HandmadeVendor::WITHDRAW_LIST[URI], 'getWithdrawListView')->name('withdraw_list');
            Route::get(HandmadeVendor::WITHDRAW_LIST_EXPORT[URI], 'exportWithdrawList')->name('withdraw-list-export-excel');
            Route::get(HandmadeVendor::WITHDRAW_VIEW[URI].'/{withdraw_id}/{seller_id}', 'getWithdrawView')->name('withdraw_view');
            Route::post(HandmadeVendor::WITHDRAW_STATUS[URI].'/{id}', 'withdrawStatus')->name('withdraw_status');
        });
    ...
    Route::group(['prefix' => 'magzinesellers', 'as' => 'magzinesellers.','middleware'=>['module:user_section']], function () {
        Route::controller(MagzineVendorController::class)->group(function (){
            Route::get(MagzineVendor::LIST[URI], 'index')->name('seller-list');

            // Route::get(MagzineMagzineVendor::LIST[URI], 'index')->name('magzineseller-list');
            // Route::get(HandmadeMagzineVendor::LIST[URI], 'index')->name('handmadeseller-list');



            Route::get(MagzineVendor::ADD[URI], 'getAddView')->name('add');
            Route::POST(MagzineVendor::ADD[URI], 'add');
            Route::get(MagzineVendor::ORDER_LIST[URI].'/{seller_id}', 'getOrderListView')->name('order-list');
            Route::post(MagzineVendor::STATUS[URI], 'updateStatus')->name('updateStatus');
            Route::post(MagzineVendor::DOCSTATUS[URI], 'updateDocStatus')->name('updateDocStatus');
            Route::get(MagzineVendor::EXPORT[URI], 'exportList')->name('export');
            Route::get(MagzineVendor::PRODUCT_LIST[URI].'/{seller_id}', 'getProductListView')->name('product-list');

            Route::post(MagzineVendor::SALES_COMMISSION_UPDATE[URI].'/{id}', 'updateSalesCommission')->name('sales-commission-update');
            Route::get(MagzineVendor::ORDER_DETAILS[URI].'/{order_id}/{seller_id}', 'getOrderDetailsView')->name('order-details');
            Route::get(MagzineVendor::VIEW[URI].'/{id}/{tab?}', 'getView')->name('view');
            Route::post(MagzineVendor::UPDATE_SETTING[URI].'/{id}', 'updateSetting')->name('update-setting');

            Route::get(MagzineVendor::WITHDRAW_LIST[URI], 'getWithdrawListView')->name('withdraw_list');
            Route::get(MagzineVendor::WITHDRAW_LIST_EXPORT[URI], 'exportWithdrawList')->name('withdraw-list-export-excel');
            Route::get(MagzineVendor::WITHDRAW_VIEW[URI].'/{withdraw_id}/{seller_id}', 'getWithdrawView')->name('withdraw_view');
            Route::post(MagzineVendor::WITHDRAW_STATUS[URI].'/{id}', 'withdrawStatus')->name('withdraw_status');
        });
