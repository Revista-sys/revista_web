...
Route::group(['prefix' => 'vendor', 'as' => 'vendor.'], function () {
   ...
   Route::group(['prefix' => 'magzineproducts', 'as' => 'magzineproducts.'], function () {
            Route::controller(MagzineProductController::class)->group(function () {
                ...
                Route::post(MagzineProduct::ADD[URI], 'add');


Route::post(MagzineProduct::SUBSCRIBE[URI], 'subscribe');
                ...
                Route::get(MagzineProduct::VIEW[URI] . '/{id}', 'getView')->name('view');
                ...
                Route::get(MagzineProduct::STOCK_LIMIT[URI], 'getStockLimitListView')->name('stock-limit-list');
