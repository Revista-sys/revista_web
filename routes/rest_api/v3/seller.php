...
Route::group(['namespace' => 'RestAPI\v3\seller', 'prefix' => 'v3/seller', 'middleware' => ['api_lang']], function () {
    ...
    // Route::group(['middleware' => ['']], function () {
        ...
        Route::group(['prefix' => 'products'], function () {
         ...
         Route::group(['prefix' => 'magzineproducts'], function () {
            Route::post('upload-images', 'MagzineProductController@upload_images');
            Route::post('upload-digital-product', 'MagzineProductController@upload_digital_product');
            Route::post('add', 'MagzineProductController@add_new');
            Route::get('list', 'MagzineProductController@list');
            Route::get('details/{id}', 'MagzineProductController@details');
            Route::get('stock-out-list', 'MagzineProductController@stock_out_list');
            Route::put('status-update', 'MagzineProductController@status_update');
            Route::get('edit/{id}', 'MagzineProductController@edit');
            Route::put('update/{id}', 'MagzineProductController@update');
            Route::get('review-list/{id}', 'MagzineProductController@review_list');
            Route::put('quantity-update', 'MagzineProductController@product_quantity_update');
            Route::delete('delete/{id}', 'MagzineProductController@delete');
            Route::get('barcode/generate', 'MagzineProductController@barcode_generate');
            Route::get('top-selling-product', 'MagzineProductController@top_selling_products');
            Route::get('most-popular-product', 'MagzineProductController@most_popular_products');
            Route::get('delete-image', 'MagzineProductController@deleteImage');
            Route::get('get-product-images/{id}', 'MagzineProductController@getProductImages');
        });
