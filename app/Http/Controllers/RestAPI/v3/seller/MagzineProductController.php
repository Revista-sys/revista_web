...
class MagzineProductController extends Controller
{
    // public function list(Request $request)
    // {
    //     $seller = $request->seller;
    //     $products = MagzineProduct::withCount('reviews')
    ...
    //     $seller = $request->seller;
    //     $products = MagzineProduct::withCount('reviews')
    //         ->where(['added_by' => 'seller', 'user_id' => $seller])
    //         ->orderBy('id', 'DESC')
    //         ->get();
    ...
    // }
       ...
       public function list(Request $request)
    {
        // $seller = $request->seller_type;

$limit = $request->limit; // Default limit is 10, can be adjusted as needed
$offset = $request->offset; // Default offset is 0, can be adjusted as needed
    ...
    {
        $products = MagzineProduct::with(['rating','tags','reviews'])
            ->withCount('reviews')
    ...
    // {
    //     $seller = $request->seller;
    //     $product = MagzineProduct::withCount('reviews')->where(['added_by' => 'seller', 'user_id' => $seller->id])->find($id);
     ...
     public function details(Request $request, $id)
    {
        ...
        // $product = MagzineProduct::withCount('reviews')->where(['added_by' => 'seller', 'id' => $id]);
 ...
 $product = MagzineProduct::withCount('reviews')
            ->where(['added_by' => 'seller', 'id' => $id])
            ->orderBy('id', 'DESC')
            ->get();
    ...
    public function stock_out_list(Request $request)
    {
        ...
        $products = MagzineProduct::withCount('reviews')->where(['added_by' => 'seller', 'user_id' => $seller->id, 'product_type' => 'physical', 'request_status' => 1])
    ...
    {
        $product = MagzineProduct::withoutGlobalScopes()->with('translations','tags')->withCount('reviews')->find($id);
    ...
    {
        $seller = $request->seller;
        $product = MagzineProduct::withCount('reviews')->find($id);
    ...
    {
        $product = MagzineProduct::withCount('reviews')->find($request->product_id);
    ...
    {
        $seller = $request->seller;
        $product = MagzineProduct::withCount('reviews')->where(['added_by' => 'seller', 'user_id' => $seller->id])->find($request->id);
        if (!$product) {
    ...
    public function delete(Request $request, $id)
    {
        ...
        $product->delete();
        FlashDealMagzineProduct::where(['product_id' => $id])->delete();
    ...
    public function barcode_generate(Request $request)
    {
        ...
        $product = MagzineProduct::withCount('reviews')->where('id', $request->id)->first();
    ...
    {
        $seller = $request->seller;
        $products = MagzineProduct::with(['rating','tags'])
            ->withCount('reviews')
    ...
    {
        $product = MagzineProduct::withCount('reviews')->find($product_id);
...
$limit = $request->limit; // Example: Limit of 10
$offset = $request->offset; // Example: Offset of 0

$categories = MagzineCategory::with([
    'childes.childes', 
...
return response()->json($categories, 200);
    ...
    {
        $product = MagzineProduct::withCount('reviews')->find($request['id']);
        $array = [];
        ...
        MagzineProduct::withCount('reviews')->where('id', $request['id'])->update([
