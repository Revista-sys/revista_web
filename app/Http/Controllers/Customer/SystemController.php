...
class SystemController extends Controller
{
    ...
    public static function insert_into_cart_shipping($request)
    {
        ...
        //dd($getCartList);
       //auth('customer')->id()
       $cityData = ShippingAddress::where('customer_id',auth('customer')->id())->select('city')->get();
        ...
        $response = $client->post('https://api.fastcoo-tech.com/API/rate', [
            'json' => [
        ...
        $shipping['shipping_cost'] = $responseBody->price; //ShippingMethod::find($request['id'])->cost;
        $shipping->save();
    }
