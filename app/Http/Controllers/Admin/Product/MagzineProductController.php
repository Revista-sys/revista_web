...
class MagzineProductController extends BaseController
{
    ...
    public function getAddView(): View
    {
        ...
        return view(MagzineProduct::ADD[VIEW], compact('categories', 'brands', 'brandSetting', 'digitalProductSetting', 'colors', 'attributes', 'languages', 'defaultLanguage'));
    }
    ...
    public function add(MagzineProductAddRequest $request, MagzineProductService $service): JsonResponse|RedirectResponse
    {
        ...
        return redirect()->route('admin.magzineproducts.list', ['in_house']);
    }
...
// die;
        ...
        return view(MagzineProduct::LIST[VIEW], compact('products', 'sellers', 'brands',
    ...
    public function update(MagzineProductUpdateRequest $request, MagzineProductService $service, string|int $id): JsonResponse|RedirectResponse
    {
        ...
        return redirect()->route(MagzineProduct::VIEW[ROUTE],['addedBy'=>$product['added_by'],'id'=>$product['id']]);
    }
    ...
    public function getView(string $addedBy,string|int $id): View
    {
        ...
        return view(MagzineProduct::VIEW[VIEW], compact('product', 'reviews', 'productActive', 'productColors','addedBy'));
    }
    ...
    public function updatedProductList(Request $request): View
    {
        ...
        return view(MagzineProduct::UPDATED_PRODUCT_LIST[VIEW], compact('products', 'searchValue'));
    }
