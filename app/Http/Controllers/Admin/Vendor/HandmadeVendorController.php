...
class HandmadeVendorController extends BaseController
{
    use PaginatorTrait;
    use CommonTrait;
    ...
    public function getListView(Request $request): View
    {
        ...
        $sellers = $this->vendorRepo->getListWhere(
            ...
            filters: ['seller_type' => 2],
            dataLimit:getWebConfig(name: WebConfigKey::PAGINATION_LIMIT)
        );
        return view(HandmadeVendor::LIST[VIEW], compact('sellers', 'current_date'));
    }

    public function getAddView(Request $request): View
    {
        return view(HandmadeVendor::ADD[VIEW]);
    }
    ...
    public function updateCommissionStatus(Request $request): RedirectResponse
    {
        $vendor = $this->vendorRepo->getFirstWhere(params:['id' => $request['id']]);
        $this->vendorRepo->update(id: $request['id'], data: ['sales_commission_percentage' => $request['sales_commission_percentage']]);
        Toastr::success('Vendor Commission update successfully');
        return back();
    }
    ...
    public function getOrderListView(Request $request, $seller_id): View
    {
        ...
        return view(HandmadeVendor::ORDER_LIST[VIEW], compact('orders', 'seller'));
    }
    ...
    public function getProductListView(Request $request, $seller_id): View
    {
        ...
        $seller = $this->vendorRepo->getFirstWhere(params: ['id'=>$seller_id]);
        return view(HandmadeVendor::PRODUCT_LIST[VIEW], compact('products', 'seller'));
    }
    ...
    public function getOrderDetailsView($order_id, $seller_id): View
    {
        ...
        return view(HandmadeVendor::ORDER_DETAILS[VIEW], compact('order', 'seller_id','delivery_men', 'linked_orders','physical_product',
    ...
    public function getView(Request $request, $id, $tab = null): View|RedirectResponse
    {
        ...
        return view(HandmadeVendor::VIEW[VIEW], [
            'seller' => $seller,
            'current_date' => date('Y-m-d'),
        ]);
    }
    ...
    public function getOrderListTabView(Request $request, $seller): View
    {
        ...
        return view(HandmadeVendor::VIEW_ORDER[VIEW], compact('seller', 'orders','pendingOrder','deliveredOrder'));
    }
    ...
    public function getProductListTabView(Request $request, $seller): View
    {
        ...
        return view(HandmadeVendor::VIEW_PRODUCT[VIEW], compact('seller', 'products'));
    }

    public function getSettingListTabView(Request $request, $seller, $id): View
    {
        return view(HandmadeVendor::VIEW_SETTING[VIEW], compact('seller'));
    }
    ...
    public function getTransactionListTabView(Request $request, $seller): View
    {
        ...
        return view(HandmadeVendor::VIEW_TRANSACTION[VIEW], compact('seller', 'transactions'));
    }
    ...
    public function getReviewListTabView(Request $request, $seller): View
    {
        ...
        return view(HandmadeVendor::VIEW_REVIEW[VIEW], [
            'seller' => $seller,
            'reviews' => $reviews,
        ]);
    }
    ...
    public function getWithdrawView($withdraw_id, $seller_id): View|RedirectResponse
    {
        ...
        if ($withdrawRequest) {
            ...
            return view(HandmadeVendor::WITHDRAW_VIEW[VIEW], compact('withdrawRequest', 'withdrawalMethod','direction'));
        }
    ...
    public function getWithdrawListView(Request $request): View
    {
        ...
        return view(HandmadeVendor::WITHDRAW_LIST[VIEW], compact('withdrawRequests'));
    }
