...
<div class="modal-body rtl">
    <div class="row ">
        ...
        <div class="col-lg-7 col-md-8 col-12 mt-md-0 mt-sm-3 web-direction">
            <div class="details __h-100 quickajay">
...
if ($user) 
{
    if ($user->prime_member_status == 0 && $product->prime_product_status != 1) {?>

<button class="btn btn-secondary  <?php echo $disableButtons ? '' : 'hidden-buttons'; ?>" type="button"  >
    {{translate('buy_now')}}
</button>
<button class="btn btn--primary string-limit  <?php echo $disableButtons ? '' : 'hidden-buttons'; ?>" type="button" >
...
else if ($user->prime_member_status == 0 && $product->prime_product_status == 1) {?>

<p> This Product Not For Regular User its prime Product</p>



   <?php  }

   else if ($user->prime_member_status == 1 && $product->prime_product_status == 1) {?>
...
<button class="btn btn--primary string-limit" type="button" >
   ...
   <?php  }
    ...
    else if ($user->prime_member_status == 1 && $product->prime_product_status == 0) {?>
...
elseif(!$user && $product->prime_product_status == 1){?>
