                                                                    ...
                                                                    <a class="product-preview-thumb color-variants-preview-box-{{ $photo->color }} {{$key==0?'active':''}} d-flex align-items-center justify-content-center"
                                                                       ...
                                                                       href="#image{{$photo->color}}">
                                                                        <img alt="{{ translate('product') }}"
                                                                             ...
                                                                             src="{{ getValidImage(path: 'storage/app/public/product/thumbnail/2024-05-16-6645e50d62ac9.png', type: 'product') }}">
                                                                    </a>
                                                                </div>
                                                            @else
                                                                <div class="" style="display:none">
...
<div class="merchant name"> {{$vendor->f_name}} {{$vendor->l_name}} <span class="__inline-25" ></span>
                                  <span> &nbsp;Visitor Count (2)</span></div>


                                <div class="d-none d-flex flex-wrap align-items-center mb-2 pro" style="display:none!important">
                                    ...
                                    <span class="__inline-25" style="display: none;"></span>
                                ...
                                <form id="add-to-cart-form" class="mb-2">
                                    ...
                                    <div class="__btn-grp mt-2 mb-3  d-sm-flex">
...
<a href="{{ $product->button_url }}" class="btn btn--primary btn-sm string-limit btn-gap-{{ Session::get('direction') === "rtl" ? 'left' : 'right' }}"
   @if(!$product->is_enabled) disabled @endif>
    @if($product->icon_class)
        <i class="{{ $product->icon_class }}"></i> <!-- Replace with dynamic icon class if needed -->
    @endif
    {{ $product->button_name }}
</a>
                                        ...
                                        @else
                                           ...
                                           <!--  <button class="btn btn--primary element-center btn-gap-{{Session::get('direction') === "rtl" ? 'left' : 'right'}} action-add-to-cart-form"
                                                type="button" data-update-text="{{ translate('update_cart') }}" data-add-text="{{'Register Now'}}">
                                                <span class="string-limit">{{$product->button_name}}</span>
                                            </button> -->
   ...
   @if(!$product->is_enabled) disabled @endif>
    ...
    {{ $product->button_name }}
                                        ...
                                        @endif
                                        <button type="button" style="display:none!important" data-product-id="{{ $product['id'] }}"
                        ...
                        <div class="mt-4 rtl col-12 text-align-direction">
                            <div class="row">
                                <div class="col-12">
                                    <div>
                                        <div
                                            class="px-4 pb-3 mb-3 mr-0 mr-md-2 bg-white __review-overview __rounded-10 pt-3" style="display:none">
                ...
                <div class="col-lg-3">
                    ...
                    @if($companyReliability != null)
                        <div class="product-details-shipping-details" style="display:none;">
                    ...
                    <div class="__inline-31" style="display: none;">
                    ...
                    <div class="pt-4 pb-3" style="display: none;">
