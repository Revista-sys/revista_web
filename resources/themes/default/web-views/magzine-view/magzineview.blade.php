...
@section('title',translate('magzine_Page'))
...
@section('content')
    ...
    <div class="container py-4 __inline-67" >
        <div class="rtl">
            <div class="bg-white __shop-banner-main" style="display:none;">
                @if($shop['id'] != 0)
        ...
        <div class="d-flex flex-wrap gap-3 justify-content-sm-between py-4 web-direction">
            ...
            <div class="d-flex flex-column flex-sm-row gap-3" style="display: none!important;">
                <form>
                                    ...
                                    <div class="card-header flex-between">
                                        <div>
                                            <label class="for-hover-label cursor-pointer get-view-by-onclick"
                                                   data-link="{{route('magzineView',['category_id'=>$category['id']])}}">
                                                {{$category['name']}}
                                            </label>
                                        </div>
...
?>
            ...
            <div class="col-lg-9 product-div">
                @if (count($products) > 0)
                    <div class="row g-3 ajay" id="ajax-products">
                        @include('web-views.magzine._ajax-products',['products'=>$products,'decimal_point_settings' => $decimalPointSettings])
                    </div>
                @else
