...
@section('content')
 ...
 <div class="feature-product-title mt-0 web-text-primary">
                        {{ translate('hand_made_Products')}}
                    </div>
                    <div class="text-end px-3 d-none d-md-block">
                        <a class="text-capitalize view-all-text web-text-primary" href="{{route('products',['data_from'=>'handmade','page'=>1])}}">
                            {{ translate('view_all')}}
                  ...
                  <!--   <div class="feature-product" style="display: none;">
                        <div class="carousel-wrap p-1">
                            <div class="owl-carousel owl-theme ajay" id="featured_products_list">
                    ...
                    <div class="feature-product" >
                        <div class="carousel-wrap p-1">
                            <div class="owl-carousel owl-theme ajay" id="featured_products_list">
                                 ...
                                 @foreach($handmade_products as $product)
                                    <div>
                                        @include('web-views.partials._handmade-product',['product'=>$product, 'decimal_point_settings'=>$decimalPointSettings])
                                    </div>
                                @endforeach
                            </div>
                        </div>
