...
@section('content')
    ...
    <div class="container py-3" dir="{{Session::get('direction')}}">
        <div class="search-page-header">
            <div>
            <?php
                $header = $data['data_from'];

                if($header=='featured'){
                    $header = 'Handmade';
                }
            ?>
                <h5 class="font-semibold mb-1">{{translate(str_replace('_',' ',$header))}} {{translate('products')}} {{ isset($data['brand_name']) ? '('.$data['brand_name'].')' : ''}}</h5>
                ...
                <div class="cz-sidebar __inline-35" id="shop-sidebar">
                    ...
                    <div class="pb-0">
                        <div class="text-center">
                            <div class="__cate-side-title border-bottom" style="display: none;">
                                <span class="widget-title font-semibold">{{translate('filter')}} </span>
                            </div>
                            <div class="__p-25-10 w-100 pt-4" style="display: none;" >
                            ...
                            <div class="__p-25-10 w-100 pt-0 d-lg-none" style="display: none;">
                    ...
                    <div>
                        <div class="text-center" style="display: none;">
                            ...
                            <div class="d-flex justify-content-between align-items-center __cate-side-price" style="display: none;">
                                <div class="__w-35p">
                                    <input
