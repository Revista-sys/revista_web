...
$isPrimeUser = $user && $user->prime_member_status == 1;
$isPrimeProduct = $product->prime_product_status == 1;

if ($user) {
    if ($isPrimeUser) {
        // Prime User
        if ($isPrimeProduct) {
            // Prime Product for Prime User
            ?>
            ...
            // Regular Product for Prime User
            ?>
            <button class="btn btn-secondary" type="button">
                {{translate('buy_now')}}
            </button>
        ...
        // Regular User
        if ($isPrimeProduct) {
            // Prime Product for Regular User
            ?>
            <p>This Product Not For Regular User its prime Product</p>
            <?php
        } else {
            // Regular Product for Regular User
            ?>
    ...
    // Not Authenticated
    if ($isPrimeProduct) {
        // Prime Product for Guest
        ?>
        <p>Please login to purchase this prime product.</p>
        <?php
    } else {
        // Regular Product for Guest
        ?>
        <button class="btn btn-secondary" type="button">
            {{translate('buy_now')}}
        </button>
