...
if (strpos($currentURL, 'demo-prdoduct') !== false) {?>
                    ...
                    <div class="row">
                                                ...
                                                @foreach (json_decode($product->color_image) as $key => $photo)
                                                    @if($photo->color != null)
                                                        <div
                                                            ...
                                                            <img class="cz-image-zoom img-responsive w-100"
                                                                 ...
                                                                 data-zoom="{{ getValidImage(path: 'storage/app/public/product/thumbnail/2024-05-16-6645e50d62ac9.png', type: 'product')  }}"
                                                    ...
                                                    @else
                                                        <div
                                                            ...
                                                            id="image{{$key}}">
                                                            <img class="cz-image-zoom img-responsive w-100"
                                                                 src="{{ getValidImage(path: 'storage/app/public/product/thumbnail/2024-05-16-6645e50d62ac9.png', type: 'product') }}"  data-zoom="{{ getValidImage(path: 'storage/app/public/product/thumbnail/2024-05-16-6645e50d62ac9.png', type: 'product')  }}"
                                                                 alt="{{ translate('product') }}" width="">
                                                            <div class="cz-image-zoom-pane"></div>
                                                        </div>
                                                    @endif
                        ...
                        <div class="col-lg-7 col-md-8 col-12 mt-md-0 mt-sm-3 web-direction">
                            <div class="details __h-100">
                                <span class="mb-2 __inline-24">{{'Demo Product'}}</span>
                                <div class="d-flex flex-wrap align-items-center mb-2 pro" style="display:none!important;">
                ...
                <?php }
elseif(strpos($currentURL, 'demo-prdoduct2') !== false) {?>
...
<div class="col-lg-9 col-12">
                    <div class="row">
                        ...
                        <div class="col-lg-7 col-md-8 col-12 mt-md-0 mt-sm-3 web-direction">
                            <div class="details __h-100">
                                <span class="mb-2 __inline-24">{{'Demo Product2'}}</span>
                                <div class="d-flex flex-wrap align-items-center mb-2 pro" style="display:none!important;">
                                    <div class="star-rating me-2">
                                        @for($inc=1;$inc<=5;$inc++)
                                            @if ($inc <= (int)$overallRating[0])
