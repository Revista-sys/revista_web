        ...
        <div class="card __card mb-3">
            <div class="card-header">
                <h5 class="card-title m-0 fs-16 font-semi-bold d-flex align-items-center gap-2">
                    <i class="testjay fa fa-user-o" aria-hidden="true"></i>
...
<!--  <div class="col-sm-6">
                        <div class="custom-file mt-3">
                           <select class="form-control" name="merchant_type">
                               <option value="">Please Select Merchant type</option>
                               <option value="1">Main Merchant</option>
                               <option value="2">Handmade Merchant</option>
                               <option value="3">Magzine Merchant</option>
                           </select>
                        </div>
                    </div>
 -->

        <div class="col-sm-4  custom-control custom-radio flex-grow-1" style="text-align: center;">
                                    <input type="radio" class="custom-control-input" value="1" name="merchant_type"
                                           id="single_vendor1">
                                    <label class="custom-control-label"
                                           for="single_vendor1">{{translate('main_merchant')}}</label>
                                </div>

                                <div class="col-sm-4 custom-control custom-radio flex-grow-1">
                                    <input type="radio" class="custom-control-input" value="2" name="merchant_type"
                                           id="single_vendor2">
                                    <label class="custom-control-label"
                                           for="single_vendor2">{{translate('handmade_merchant')}}</label>
                                </div>

                                <div class="col-sm-4 custom-control custom-radio flex-grow-1">
                                    <input type="radio" class="custom-control-input" value="3" name="merchant_type"
                                           id="single_vendor3">
                                    <label class="custom-control-label"
                                           for="single_vendor3">{{translate('magazine_merchant')}}</label>
                                </div>
