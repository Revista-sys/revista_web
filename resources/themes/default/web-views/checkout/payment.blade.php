                            ...
                            @if($cashOnDeliveryBtnShow && $cash_on_delivery['status'] || $digital_payment['status']==1)
                                <div class="d-flex flex-wrap gap-3 mb-5">
                                    @if($cashOnDeliveryBtnShow && $cash_on_delivery['status'])
                                        <div id="cod-for-cart" style="display:contents;">
                                            <div class="card cursor-pointer">
                                             ...
                                             <div class="card cursor-pointer">
                                                <form action="{{route('checkout-complete-cod')}}" method="get" class="needs-validation" id="cash_on_delivery_form_cod">
                                                    <label class="m-0">
                                                        <input type="hidden" name="payment_method" value="cash_on_delivery_cod">
                                                        <span class="btn btn-block click-if-alone d-flex gap-2 align-items-center cursor-pointer">
                                                            <input type="radio" id="cash_on_delivery_cod" class="custom-radio">
                                                            <img width="20" src="{{ theme_asset(path: 'public/assets/front-end/img/icons/money.png') }}" alt="">
                                                            <span class="fs-12">{{ 'cash on deleivery' }}</span>
                                                        </span>
                                                    </label>
                                                </form>
                                            </div>
