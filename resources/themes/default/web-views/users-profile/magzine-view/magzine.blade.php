                    ...
                    <div class="row mx-n2 __min-h-200px">
                        ...
                        <div class="col-lg-3 col-md-6 col-sm-12 px-2 pb-4 text-center">
                                <a href="{{route('magzineView',['id'=>1])}}" class="others-store-card text-capitalize">
                                    <div class="overflow-hidden other-store-banner">
                                        @if($seller['id'] != 0)
                                            <img class="w-100 h-100 object-cover" alt="" src="{{ getValidImage(path: 'storage/app/public/magzine/2024-05-16-6645e07f000e2.gif', type: 'shop-banner') }}">
                                        @else
                                            <img class="w-100 h-100 object-cover" alt="" src="{{ getValidImage(path: 'storage/app/public/magzine/banner/2024-05-16-6645b5c694e73.webp', type: 'shop-banner') }}">
                                        @endif
                                    </div>
                                    <div class="name-area">
                                        <div class="position-relative" style="display:none">
                                        ...
                                        <div class="info pt-4 pl-4">
                                            <h5 class="text-start">{{ 'Candies' }}</h5>
                                            <div class="d-flex align-items-center">
                            ...
                            <div class="col-lg-3 col-md-6 col-sm-12 px-2 pb-4 text-center">
                                <a href="{{route('magzineView',['id'=>2])}}" class="others-store-card text-capitalize">
                                    <div class="overflow-hidden other-store-banner">
                                        @if($seller['id'] != 0)
                                            <img class="w-100 h-100 object-cover" alt="" src="{{ getValidImage(path: 'storage/app/public/magzine/banner/2024-05-16-6645b60c33c9b.webp', type: 'shop-banner') }}">
                                        @else
                                            <img class="w-100 h-100 object-cover" alt="" src="{{ getValidImage(path: 'storage/app/public/magzine/2024-05-16-6645b5c694e73.webp', type: 'shop-banner') }}">
                                        @endif
                                    </div>
                                    <div class="name-area">
                                        <div class="position-relative" style="display:none">
                                            <div class="overflow-hidden other-store-logo rounded-full">
                                                @if($seller['id'] != 0)
                                                    <img class="rounded-full" alt="{{ translate('store') }}"
                                                         src="{{ getValidImage(path: 'storage/app/public/magzine/2024-05-16-6645b66005687.webp', type: 'shop') }}">
                                                @else
                                                <img class="rounded-full" alt="{{ translate('store') }}"
                                                     src="{{ getValidImage(path: 'storage/app/public/magzine/banner/2024-05-16-6645b5c694e73.webp', type: 'shop') }}">
                                                @endif
                                        ...
                                        <div class="info pt-4 pl-4">
                                            <h5 class="text-start">{{ 'Courses' }}</h5>
                                            <div class="d-flex align-items-center">
                                                <h6 class="web-text-primary">{{number_format(2.5,1)}}</h6>
                                                <i class="tio-star text-star mx-1"></i>
                                                <small>{{ translate('rating') }}</small>
                            ...
                            <div class="col-lg-3 col-md-6 col-sm-12 px-2 pb-4 text-center">
                                <a href="{{route('magzineView',['id'=>3])}}" class="others-store-card text-capitalize">
                                    <div class="overflow-hidden other-store-banner">
                                        @if($seller['id'] != 0)
                                            <img class="w-100 h-1
                                            00 object-cover" alt="" src="{{ getValidImage(path: 'storage/app/public/shop/banner/'.$seller['banner'], type: 'shop-banner') }}">
                                        @else
                                            <img class="w-100 h-100 object-cover" alt="" src="{{ getValidImage(path: 'storage/app/public/shop/'.$seller['banner'], type: 'shop-banner') }}">
                                        @endif
                                    </div>
                                    <div class="name-area">
                                        ...
                                        <div class="info pt-4 pl-4">
                                            <h5 class="text-start">{{ 'demo1 magzine' }}</h5>
                                            <div class="d-flex align-items-center">
                                                <h6 class="web-text-primary">{{number_format(2.5,1)}}</h6>
                                                <i class="tio-star text-star mx-1"></i>
                                                <small>{{ translate('rating') }}</small>
                            ...
                            <div class="col-lg-3 col-md-6 col-sm-12 px-2 pb-4 text-center">
                                <a href="{{route('magzineView',['id'=>4])}}" class="others-store-card text-capitalize">
                                    <div class="overflow-hidden other-store-banner">
                                        @if($seller['id'] != 0)
                                            <img class="w-100 h-100 object-cover" alt="" src="{{ getValidImage(path: 'storage/app/public/magzine/2024-05-16-6645c1689f46f.webp', type: 'shop-banner') }}">
                                        @else
                                            <img class="w-100 h-100 object-cover" alt="" src="{{ getValidImage(path: 'storage/app/public/magzine/banner/2024-05-16-6645b5c694e73.webp', type: 'shop-banner') }}">
                                        @endif
                                    </div>
                                    <div class="name-area">
                                        ...
                                        <div class="info pt-4 pl-4">
                                            <h5 class="text-start">{{ 'demo2 magzine' }}</h5>
                                            <div class="d-flex align-items-center">
                                                <h6 class="web-text-primary">{{number_format(2.5,1)}}</h6>
                                                <i class="tio-star text-star mx-1"></i>
                                                <small>{{ translate('rating') }}</small>
...
<div class="col-lg-3 col-md-6 col-sm-12 px-2 pb-4 text-center">
                                <a href="{{route('magzineView',['id'=>5])}}" class="others-store-card text-capitalize">
                                    <div class="overflow-hidden other-store-banner">
                                        @if($seller['id'] != 0)
                                            <img class="w-100 h-100 object-cover" alt="" src="{{ getValidImage(path: 'storage/app/public/magzine/2024-05-16-6645b66005687.webp', type: 'shop-banner') }}">
                                        @else
                                            <img class="w-100 h-100 object-cover" alt="" src="{{ getValidImage(path: 'storage/app/public/magzine/banner/2024-05-16-6645b5c694e73.webp', type: 'shop-banner') }}">
                                        @endif
                                    </div>
                                    <div class="name-area">
                                        ...
                                        <div class="info pt-4 pl-4">
                                            <h5 class="text-start">{{ 'demo3 magzine' }}</h5>
                                            <div class="d-flex align-items-center">
                                                <h6 class="web-text-primary">{{number_format(2.5,1)}}</h6>
                                                <i class="tio-star text-star mx-1"></i>
                                                <small>{{ translate('rating') }}</small>
