...
<header class="rtl __inline-10">
                ...
                <div class="collapse navbar-collapse text-align-direction" id="navbarCollapse">
                    ...
                    <ul class="navbar-nav">
                        ...
                        @if ($discount_product>0)
                            <li style="display:none" class="nav-item dropdown {{request()->is('/')?'active':''}}">
 ...
 <li class="nav-item dropdown {{request()->is('/')?'active':''}}">
                            <a class="nav-link" href="{{'/products?data_from=handmade&page=1'}}">{{ translate('Handmade')}}</a>
                        </li>
   
                        <li class="nav-item dropdown ">
                            <a class="nav-link" href="/magzineView">Newsletter</a>
                        </li>
