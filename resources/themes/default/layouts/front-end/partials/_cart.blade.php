<div class="test1 navbar-tool dropdown me-2 {{ Session::get('direction') === 'rtl' ? 'mr-md-3' : 'ml-md-3' }}">
...
$authuser= auth('customer')->user()->prime_member_status??'';
 $isPrimeProduct = $product->prime_product_status ?? '';
     if ($authuser == 1 && $isPrimeProduct == 0 ) {?>
                ...
                {{ webCurrencyConverter(amount: \App\Utils\CartManager::cart_total(\App\Utils\CartManager::get_cart())) }}
...
?>
 ...
 if( isset($authuser) && $authuser == 1 &&  $isPrimeProduct == 0)
{?>
