...
<input type='hidden' name="seller_type" value="{{auth()->guard('seller')->user()->seller_type}}"/>
 ...
 <input style="width:10%" type="hidden"  value="0" name="primeproduct"  class="form-control" />
                                 ...
                                 <input style="width:10%" type="checkbox" value="1" name="primeproduct" id="primeproduct" class="form-control" />
                        ...
                        <div class="col-md-6 col-lg-4 col-xl-3" >
                            <div class="form-group">
                                <div class="d-flex gap-2">
                                    <label class="title-color" for="discount">{{ 'Prime Discount Amount' }} <span
                        ...
                        <div class="col-md-6 col-lg-4 col-xl-3 physical_product_show" id="shipping_cost" style="display: none;">
                            <div class="form-group" style="display: none;">
                                <div class="d-flex gap-2">
