...
@section('content')
            ...
            <div class="card mt-3 rest-part">
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-md-6 col-lg-4 col-xl-3" id="digital_product_type_show" style="display: none;">
                            <div class="form-group">
                        ...
                        <div class="col-md-6 col-lg-4 col-xl-3 physical_product_show" style="display: none;">
 ...
 <div class="col-md-6 col-lg-4 col-xl-3 physical_product_show" id="quantity">
  ...
  <label  class="title-color">{{ 'Prime Product' }}</label>
...
?>
 ...
 <input style="width:10%" type="hidden"  value="0" name="primeproduct"  class="form-control" />

                                 <input style="width:10%" type="checkbox" value="1" name="primeproduct"

<?php echo ($product['prime_product_status'] == 1) ? 'checked' : ''; ?> 
                                  id="primeproduct" class="form-control" />
                        ...
                        <div class="col-md-6 physical_product_show" id="shipping_cost_multy" style="display: none;">
                            <div class="form-group" style="display: none;">
                                <div
