                        ...
                        <div class="col-sm-6 col-lg-4 col-xl-3">
                            <div class="form-group">
                                ...
                                <select class="js-select2-custom form-control action-get-request-onchange" name="category_id"
                                        data-url-prefix="{{ url('/vendor/magzineproducts/get-categories?parent_id=') }}"
                    ...
                    <div class="px-3 py-4">
                        <div class="row align-items-center">
                            ...
                            <div class="col-lg-8 mt-3 mt-lg-0 d-flex flex-wrap gap-3 justify-content-lg-end">
                                    ...
                                    <ul class="dropdown-menu dropdown-menu-right">
                                        <li>
                                            <a class="dropdown-item"
                                               href="{{ route('vendor.magzineproducts.export-excel', ['type'=>$type,'brand_id'=>request('brand_id'),'category_id'=>request('category_id'),'sub_category_id'=>request('sub_category_id'),'sub_sub_category_id'=>request('sub_sub_category_id'),'searchValue'=>request('searchValue')]) }}">
                                ...
                                @if($type != 'new-request' )
                                <a href="{{ route('vendor.magzineproducts.stock-limit-list') }}" class="btn btn-info">
                                    <i class="tio-add-circle"></i>
                                    <span class="text">{{ translate('limited_Stocks') }}</span>
                                </a>
                                <a href="{{ route('vendor.magzineproducts.add') }}" class="btn btn--primary">
                                    <i class="tio-add"></i>
                    ...
                    <div class="table-responsive">
                        <table id="datatable"
                            ...
                            <tr>
                                ...
                                <th class="text-center text-capitalize" style="display:none">{{ translate('product_type') }}</th>
                                <th class="text-center text-capitalize" style="display:none">{{ translate('unit_price') }}</th>

                              <th class="text-center text-capitalize">{{'Payment Status'}}</th>
                            ...
                            @foreach($products as $key=>$product)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('vendor.magzineproducts.view', [$product['id']]) }}"
                                    ...
                                    <td class="text-center" style="display:none">
                                        ...
                                        @elseif($product->payment_status == 1)
                                            <label class="badge badge-soft-success">{{'Paid'}}</label>
                                        @endif
                                    </td>
                                    ...
                                    @if($type != 'new-request' )
                                        <td class="text-center">
                                            ...
                                            <form action="{{ route('vendor.magzineproducts.status-update') }}" method="post" data-from="product-status"
                                    ...
                                    <td>
                                        <div class="d-flex justify-content-center gap-2">
                                            @if($type != 'new-request' )
                                                <a style="display:none" class="btn btn-outline-info btn-sm square-btn"
                                                   ...
                                                   href="{{ route('vendor.magzineproducts.barcode', [$product['id']]) }}">
                                                    <i class="tio-barcode"></i>
                                                </a>
                                                <a class="btn btn-outline-info btn-sm square-btn" title="{{ translate('view') }}"
                                                   href="{{ route('vendor.magzineproducts.view', [$product['id']]) }}">
                                                    <i class="tio-invisible"></i>
                                                </a>
                                            @endif
                                            <a class="btn btn-outline--primary btn-sm square-btn"
                                               title="{{ translate('edit') }}"
                                               href="{{ route('vendor.magzineproducts.update',[$product['id']]) }}">
                                                <i class="tio-edit"></i>
                                            </a>
                                        ...
                                        <form action="{{ route('vendor.magzineproducts.delete',[$product['id']]) }}"
