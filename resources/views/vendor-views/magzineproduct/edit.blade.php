...
@section('content')
    <div class="content container-fluid">
        ...
        <form class="product-form text-start" action="{{route('vendor.magzineproducts.update',$product->id)}}" method="post"
...
if($product['status']==1 && $product['unit_price']!='' &&  $product['unit_price']!=0)
{?>
                        ...
                        <div class="mb-2">
                            <label for="from" class="title-color d-flex">{{ translate('from') }}{{$product['from']}}</label>
                             <input type="date" disabled name="from" id="start-date-time" value="{{$product['magzine_start_date']}}"
                                   class="form-control"
...
<?php
                        ...
                        <div class="mb-2">
                            <label for="from" class="title-color d-flex">{{ translate('from') }}{{$product['from']}}</label>
                            <input type="date"  name="from" id="start-date-time" value="{{$product['magzine_start_date']}}"
                                   class="form-control"
                                   title="{{ translate('from_date') }}">
                        </div>
                    </div>
...
{?>
 ...
 <div class="col-md-6 col-md-4 col-xl-3">
                        <div class="mb-2">
                           ...
                           <input type="date" disabled name="to" id="end-date-time" value="{{$product['magzine_end_date']}}"
                                   class="form-control"
...
<?php
   ...
   <div class="col-md-6 col-md-4 col-xl-3">
                        <div class="mb-2">
                            <label for="to" class="title-color d-flex">{{ translate('to') }}</label>
                            <input type="date" name="to" id="end-date-time" value="{{$product['magzine_end_date']}}"
                                   class="form-control"
                                   title="{{ ucfirst(translate('to_date')) }}">
                        </div>
                    </div>
...
<input type="hidden" id="price" value="{{ usdToDefaultCurrency($product['unit_price']) }}"> 
...
<?php } ?>
            ...
            <div class="col-md-6 col-lg-4 col-xl-3" style="display: none;" >
                            <div class="form-group" >
                                <div class="d-flex gap-2">
                                    <label class="title-color">{{ translate('unit_price') }}
                                        ({{ getCurrencySymbol(currencyCode: getCurrencyCode()) }}
                        ...
                        <div style="visibility: hidden;" class="col-md-6 col-lg-4 col-xl-3 physical_product_show" >
                          ...
                          <div class="col-md-6 col-lg-4 col-xl-3">
                            <div class="form-group">
                                ...
                                <input type="text"   name="buttonname"
                                       class="form-control" value="{{ $product->button_name }}"
                        ...
                        <div class="col-md-6 col-lg-4 col-xl-3">
                            <div class="form-group">
                                ...
                                <input type="text"  name="buttonurl"
                                       class="form-control" value="{{ $product->button_url }}"
...
{?>
 ...
 <div class="col-md-6 col-lg-4 col-xl-3">
                            <div class="form-group">
                               ...
                               <label class="title-color d-flex justify-content-between gap-2" style="visibility:hidden" >
                                    <span class="d-flex align-items-center gap-2" >
                                        {{ 'pay' }}
...
<button type="button" class="form-control" value="" id="paynow">Pay Now</button>
...
<?php } ?>
            ...
            <div class="card mt-3 rest-part" style="display: none;">
                <div class="card-header">
                    <div class="d-flex gap-2">
                        <i class="tio-user-big"></i>
            ...
            <div style="display: none;" class="card mt-3 rest-part physical_product_show" >
            ...
            <div class="mt-3 rest-part">
                                                ...
                                                <div class="col-sm-12 col-md-4">
                                                    <div
                                                        ...
                                                        <a class="delete_file_input_css btn btn-outline-danger btn-sm square-btn"
                                                           href="{{ route('vendor.magzineproducts.delete-image',['id'=>$product['id'],'name'=>$photo]) }}">
                                                            <i class="tio-delete"></i>
                                                        </a>
                                                    ...
                                                    @if($photo->color == null)
                                                        ...
                                                        <div class="col-sm-12 col-md-4">
                                                            <div
                                                                class="custom_upload_input custom-upload-input-file-area position-relative border-dashed-2 aspect-1">
                                                                <a class="delete_file_input_css btn btn-outline-danger btn-sm square-btn"
                                                                   href="{{ route('vendor.magzineproducts.delete-image',['id'=>$product['id'],'name'=>$photo->image_name,'color'=>'null']) }}">
                                                                    <i class="tio-delete"></i>
                                                                </a>
                ...
                <input type="hidden" id="remove_url" value="{{ route('vendor.magzineproducts.delete-image') }}">
            </div>
    ...
    <span id="route-vendor-products-sku-combination" data-url="{{ route('vendor.magzineproducts.sku-combination') }}"></span>
    ...
    <script>
        ...
        $(document).ready(function () {
            setTimeout(function () {
                ...
                getRequestFunctionality('{{ route('vendor.magzineproducts.get-categories') }}?parent_id=' + category + '&sub_category=' + sub_category, 'sub-category-select', 'select');
                getRequestFunctionality('{{ route('vendor.magzineproducts.get-categories') }}?parent_id=' + sub_category + '&sub_category=' + sub_sub_category, 'sub-sub-category-select', 'select');
            }, 100)
        });
...
<script>
    ...
    {
        let button = document.querySelector(`#paynow`);
        ...
        if (button) 
        {
            button.addEventListener('click', function() 
            {
                ...
                var price = document.querySelector(`#price`) ? document.querySelector(`#price`).value : '';

                var productid = document.querySelector(`#productid`) ? document.querySelector(`#productid`).value : '';
                ...
                if (isValid) {
                    ...
                    fetch('{{ route("vendor.magzineproducts.subscribe") }}', {
                        method: 'POST',
                        body: formData,
                        headers: {
            ...
            {
            alert(data.error);
            alert("mobile length should be 10 digits");
