...
@section('content')
    <div class="content container-fluid">
        ...
        <form class="product-form text-start" action="{{ route('vendor.magzineproducts.add') }}"
                        ...
                        <div class="col-md-6 col-lg-4 col-xl-3">
                            <div class="form-group">
                                ...
                                <select class="js-select2-custom form-control action-get-request-onchange" name="category_id"
                                        data-url-prefix="{{ route('vendor.magzineproducts.get-categories').'?parent_id=' }}"
 ...
 <div class="col-md-6 col-md-4 col-xl-3">
                        <div class="mb-2">
                            ...
                            <input type="date" name="from" id="start-date-time" value=""
                                   class="form-control"
                    ...
                    <div class="col-md-6 col-md-4 col-xl-3">
                        <div class="mb-2">
                            ...
                            <input type="date" name="to" id="end-date-time" value=""
                                   class="form-control"
                        ...
                        @if($brandSetting)
                            <div class="col-md-6 col-lg-4 col-xl-3" style="display:none">
                                <div class="form-group">
                                    ...
                                    <select class="js-select2-custom form-control" name="brand_id1" >
                                        <option value="{{ null }}" selected
            ...
            <div class="card mt-3 rest-part" style="display:none">
                ...
                <div class="card-body" >
                    <div class="row align-items-end">
                        ...
                        <div class="col-md-6 col-lg-4 col-xl-3 physical_product_show" id="quantity" style="display:none">
                            <div class="form-group">
                                <div class="d-flex gap-2 mb-2">
                                    <label class="title-color mb-0"
