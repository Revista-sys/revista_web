@php
    use App\Enums\ViewPaths\Admin\Brand;use App\Enums\ViewPaths\Admin\BusinessSettings;
    use App\Enums\ViewPaths\Admin\Category;
    use App\Enums\ViewPaths\Admin\MagzineCategory;

    use App\Enums\ViewPaths\Admin\Chatting;use App\Enums\ViewPaths\Admin\Currency;use App\Enums\ViewPaths\Admin\Customer;use App\Enums\ViewPaths\Admin\CustomerWallet;use App\Enums\ViewPaths\Admin\Dashboard;
                ...
                <div class="navbar-vertical-content">
                    ...
                    <ul class="navbar-nav navbar-nav-lg nav-tabs">
                        ...
                        @if (Helpers::module_permission_check('pos_management'))
                            <li style="display:none" class="navbar-vertical-aside-has-menu {{Request::is('admin/pos*')?'active':''}}">
                                <a class="js-navbar-vertical-aside-menu-link nav-link"
                        ...
                        @if(Helpers::module_permission_check('order_management'))
                            ...
                            <li class="navbar-vertical-aside-has-menu {{Request::is('admin/orders*')?'active':''}}">
                                ...
                                <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
                                    ...
                                    <li style="display:none" class="nav-item {{Request::is('admin/orders/'.Order::LIST[URI].'/processing')?'active':''}}">
                                    ...
                                    <li style="display:none" class="nav-item {{Request::is('admin/orders/'.Order::LIST[URI].'/out_for_delivery')?'active':''}}">
                                    ...
                                    <li style="display:none" class="nav-item {{Request::is('admin/orders/'.Order::LIST[URI].'/returned')?'active':''}}">
                                    ...
                                    <li style="display:none" class="nav-item {{Request::is('admin/orders/'.Order::LIST[URI].'/failed')?'active':''}}">
                            ...
                            <li style="display:none" class="navbar-vertical-aside-has-menu {{Request::is('admin/refund-section/refund/*')?'active':''}}">
                                <a class="js-navbar-vertical-aside-menu-link nav-link nav-link-toggle"
                        ...
                        @if(Helpers::module_permission_check('product_management'))
                            ...
                            <li class="navbar-vertical-aside-has-menu {{(Request::is('admin/category*') || Request::is('admin/sub-category*') || Request::is('admin/sub-sub-category*')) ?'active':''}}">
                                ...
                                <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
                                    ...
                                    <li class="nav-item {{Request::is('admin/sub-category/'.SubCategory::LIST[URI])?'active':''}}">
                                     ...
                                     <li class="nav-item {{Request::is('admin/category/'.Category::LIST[URI])?'active':''}}">
                                        <a class="nav-link " href="{{route('admin.magzinecategory.magzineview')}}"
                                           title="{{translate('categories')}}">
                                            <span class="tio-circle nav-indicator-icon"></span>
                                            <span class="text-truncate">{{'magzine categories'}}</span>
                                        </a>
                                    </li>


                                    <li style="display:none" class="nav-item {{Request::is('admin/sub-sub-category/'.SubSubCategory::LIST[URI])?'active':''}}">
                            ...
                            <li style="display:none" class="navbar-vertical-aside-has-menu {{Request::is('admin/brand*')?'active':''}}">
                                <a class="js-navbar-vertical-aside-menu-link nav-link nav-link-toggle"
                            ...
                            <li style="display: none;" class="navbar-vertical-aside-has-menu {{Request::is('admin/attribute*')?'active':''}}">
                                <a class="js-navbar-vertical-aside-menu-link nav-link"
                           ...
                           <!--  <li   class="navbar-vertical-aside-has-menu {{(Request::is('admin/products/'.Product::LIST[URI].'/in_house') || Request::is('admin/products/'.\App\Enums\ViewPaths\Admin\Product::BULK_IMPORT[URI]) || (Request::is('admin/products/'.\App\Enums\ViewPaths\Admin\Product::ADD[URI])) || (Request::is('admin/products/'.\App\Enums\ViewPaths\Admin\Product::VIEW[URI].'/admin/*')) || (Request::is('admin/products/'.\App\Enums\ViewPaths\Admin\Product::BARCODE_GENERATE[URI].'/*')))?'active':''}}">
                                <a class="js-navbar-vertical-aside-menu-link nav-link nav-link-toggle"
                                   href="javascript:" title="{{translate('in-House_Products')}}">
                                    ...
                                    <span class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">
                                        <span class="text-truncate">{{translate('')}}</span>
                                    </span>
                                </a>
                                <ul style="display:none" class="js-navbar-vertical-aside-submenu nav nav-sub
                                     {{(Request::is('admin/products/'.Product::ADD[URI].'/in_house') || (Request::is('admin/products/'.Product::LIST[URI].'/in_house')) || (Request::is('admin/products/'.\App\Enums\ViewPaths\Admin\Product::STOCK_LIMIT[URI].'/in_house')) || (Request::is('admin/products/'.\App\Enums\ViewPaths\Admin\Product::BULK_IMPORT[URI])) || (Request::is('admin/products/'.\App\Enums\ViewPaths\Admin\Product::ADD[URI])) || (Request::is('admin/products/'.\App\Enums\ViewPaths\Admin\Product::VIEW[URI].'/admin/*')) || (Request::is('admin/products/'.\App\Enums\ViewPaths\Admin\Product::BARCODE_GENERATE[URI].'/*')))?'block':''}}">
                                    <li  style="display:none" class="nav-item {{(Request::is('admin/products/'.Product::LIST[URI].'/in_house') || (Request::is('admin/products/'.\App\Enums\ViewPaths\Admin\Product::VIEW[URI].'/admin/*')) || (Request::is('admin/products/'.\App\Enums\ViewPaths\Admin\Product::STOCK_LIMIT[URI].'/in_house')) || (Request::is('admin/products/'.\App\Enums\ViewPaths\Admin\Product::BARCODE_GENERATE[URI].'/*')))?'active':''}}">
                                    ...
                                    <li style="display:none" class="nav-item {{Request::is('admin/products/'.Product::ADD[URI]) ? 'active':''}}">
                                    ...
                                    <li style="display:none" class="nav-item {{Request::is('admin/products/'.Product::BULK_IMPORT[URI])?'active':''}}">
                             ...
                             <!--  <li style="visibility:hidden" class="navbar-vertical-aside-has-menu {{(Request::is('admin/magzineproducts/'.Product::LIST[URI].'/in_house') || Request::is('admin/magzineproducts/'.\App\Enums\ViewPaths\Admin\MagzineProduct::BULK_IMPORT[URI]) || (Request::is('admin/magzineproducts/'.\App\Enums\ViewPaths\Admin\MagzineProduct::ADD[URI])) || (Request::is('admin/magzineproducts/'.\App\Enums\ViewPaths\Admin\MagzineProduct::VIEW[URI].'/admin/*')) || (Request::is('admin/products/'.\App\Enums\ViewPaths\Admin\MagzineProduct::BARCODE_GENERATE[URI].'/*')))?'active':''}}">
                                <a class="js-navbar-vertical-aside-menu-link nav-link nav-link-toggle"
                                   href="javascript:" title="{{translate('in-House_Products')}}">
                                    <i class="tio-shop nav-icon"></i>
                                    <span class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">
                                        <span class="text-truncate">{{'Magzine Products'}}</span>
                                    </span>
                                </a>
                                <ul style="display:none" class="js-navbar-vertical-aside-submenu nav nav-sub
                                    {{(Request::is('admin/magzineproducts/'.Product::ADD[URI].'/in_house') || (Request::is('admin/magzineproducts/'.Product::LIST[URI].'/in_house')) || (Request::is('admin/magzineproducts/'.\App\Enums\ViewPaths\Admin\MagzineProduct::STOCK_LIMIT[URI].'/in_house')) || (Request::is('admin/magzineproducts/'.\App\Enums\ViewPaths\Admin\MagzineProduct::BULK_IMPORT[URI])) || (Request::is('admin/products/'.\App\Enums\ViewPaths\Admin\MagzineProduct::ADD[URI])) || (Request::is('admin/products/'.\App\Enums\ViewPaths\Admin\MagzineProduct::VIEW[URI].'/admin/*')) || (Request::is('admin/products/'.\App\Enums\ViewPaths\Admin\MagzineProduct::BARCODE_GENERATE[URI].'/*')))?'block':''}}">
                                    <li style="display:none"
                                      class="nav-item {{(Request::is('admin/products/'.Product::LIST[URI].'/in_house') || (Request::is('admin/magzineproducts/'.\App\Enums\ViewPaths\Admin\MagzineProduct::VIEW[URI].'/admin/*')) || (Request::is('admin/magzineproducts/'.\App\Enums\ViewPaths\Admin\MagzineProduct::STOCK_LIMIT[URI].'/in_house')) || (Request::is('admin/magzineproducts/'.\App\Enums\ViewPaths\Admin\MagzineProduct::BARCODE_GENERATE[URI].'/*')))?'active':''}}">
                                        <a class="nav-link " href="{{route('admin.magzineproducts.list',['in_house', ''])}}"
                                           title="{{translate('Product_List')}}">
                                            <span class="tio-circle nav-indicator-icon"></span>
                                            <span class="text-truncate">{{translate('Product_List')}}
                                                <span class="badge badge-soft-success badge-pill ml-1">
                                    ...
                                    <li class="nav-item {{Request::is('admin/magzineproducts/'.Product::ADD[URI]) ? 'active':''}}">
                                        <a class="nav-link " href="{{route('admin.magzineproducts.add')}}"
                                           title="{{translate('add_New_Product')}}">
                                            <span class="tio-circle nav-indicator-icon"></span>
                                            <span class="text-truncate">{{translate('add_New_Product')}}</span>
                                        </a>
                                    </li>
                                    <li style="display: none;" class="nav-item {{Request::is('admin/magzineproducts/'.Product::BULK_IMPORT[URI])?'active':''}}">
                                        <a class="nav-link " href="{{route('admin.magzineproducts.bulk-import')}}"
                                           title="{{translate('bulk_import')}}">
                                            <span class="tio-circle nav-indicator-icon"></span>
                                            <span class="text-truncate">{{translate('bulk_import')}}</span>
                                        </a>
...
<li  class="navbar-vertical-aside-has-menu {{Request::is('admin/products/'.Product::LIST[URI].'/seller*')||(Request::is('admin/products/'.\App\Enums\ViewPaths\Admin\Product::VIEW[URI].'/seller/*'))||Request::is('admin/products/'.\App\Enums\ViewPaths\Admin\Product::UPDATED_PRODUCT_LIST[URI])?'active':''}}">
                                ...
                                <ul class="js-navbar-vertical-aside-submenu nav nav-sub {{Request::is('admin/products/'.\App\Enums\ViewPaths\Admin\Product::LIST[URI].'/seller*')||(Request::is('admin/products/'.\App\Enums\ViewPaths\Admin\Product::VIEW[URI].'/seller/*'))||Request::is('admin/products/'.\App\Enums\ViewPaths\Admin\Product::UPDATED_PRODUCT_LIST[URI])?'block':''}}">
                                    <li class="nav-item {{str_contains(url()->current().'?status='.request()->get('status'),'admin/products/'.\App\Enums\ViewPaths\Admin\Product::LIST[URI].'/seller?status=0')==1?'active':''}}">
                                        <a class="nav-link"
                                           title="{{translate('new_Products_Requests')}}"
                                           href="{{route('admin.products.list',['seller', 'status'=>'0', 'seller_type'=>'2'])}}">
                                            <span class="tio-circle nav-indicator-icon"></span>
                                            <span class="text-truncate">{{translate('new_Products_Requests')}}
                                                <span class="badge badge-soft-danger badge-pill ml-1">
                                                    {{getHandmadeVendorProductsCount('new-product')}}
                                                </span>
                                            </span>
                                        </a>
                                    </li>
                                    ...
                                    <li class="nav-item {{str_contains(url()->current().'?status='.request()->get('status'),'/admin/products/'.Product::LIST[URI].'/seller?status=1')==1?'active':''}}">
                                        <a class="nav-link"
                                           title="{{translate('approved_Products')}}"
                                           href="{{route('admin.products.list',['seller', 'status'=>'1', 'seller_type'=>'2'])}}">
                                            <span class="tio-circle nav-indicator-icon"></span>
                                            <span class="text-truncate">{{translate('approved_Products')}}
                                                 <span class="badge badge-soft-success badge-pill ml-1">
                                                    {{getHandmadeVendorProductsCount('approved')}}
                                                </span>
                                            </span>
                                        </a>
                                    </li>
                                    <li class="nav-item {{str_contains(url()->current().'?status='.request()->get('status'),'/admin/products/'.Product::LIST[URI].'/seller?seller_type=2&status=2')==1?'active':''}}">
                                        <a class="nav-link"
                                           title="{{translate('denied_Products')}}"
                                          href="{{route('admin.products.list',['seller', 'status'=>'2', 'seller_type'=>'2'])}}">
                                            <span class="tio-circle nav-indicator-icon"></span>
                                            <span class="text-truncate">{{translate('denied_Products')}}
                                                <span class="badge badge-soft-danger badge-pill ml-1">
                                                    {{getHandmadeVendorProductsCount('denied')}}
                                                </span>
                                            </span>
                                        </a>
                                    </li>
  ...
  <li  class="navbar-vertical-aside-has-menu {{Request::is('admin/products/'.Product::LIST[URI].'/magzineseller*')||(Request::is('admin/products/'.\App\Enums\ViewPaths\Admin\Product::VIEW[URI].'/magzineseller/*'))||Request::is('admin/products/'.\App\Enums\ViewPaths\Admin\Product::UPDATED_PRODUCT_LIST[URI])?'active':''}}">
                                <a class="js-navbar-vertical-aside-menu-link nav-link nav-link-toggle"
                                   href="javascript:"
                                   title="{{'magzine Products'}}">
                                    <i class="tio-airdrop nav-icon"></i>
                                    <span class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">
                                        {{'magzine Products'}}
                                    </span>
                                </a>
                                <ul class="js-navbar-vertical-aside-submenu nav nav-sub {{Request::is('admin/products/'.\App\Enums\ViewPaths\Admin\Product::LIST[URI].'/magzineseller*')||(Request::is('admin/products/'.\App\Enums\ViewPaths\Admin\Product::VIEW[URI].'/magzineseller/*'))||Request::is('admin/products/'.\App\Enums\ViewPaths\Admin\Product::UPDATED_PRODUCT_LIST[URI])?'block':''}}">
                                    <li class="nav-item {{str_contains(url()->current().'?status='.request()->get('status'),'admin/products/'.\App\Enums\ViewPaths\Admin\Product::LIST[URI].'/magzineseller?status=0')==1?'active':''}}">
                                        <a class="nav-link"
                                           title="{{translate('new_Products_Requests')}}"
                                           href="{{route('admin.magzineproducts.list',['magzineseller', 'status'=>'0'])}}">
                                            <span class="tio-circle nav-indicator-icon"></span>
                                            <span class="text-truncate">{{translate('new_Products_Requests')}}
                                                <span class="badge badge-soft-danger badge-pill ml-1">
                                                    {{getMagzineVendorProductsCount('new-product')}}
                                                </span>
                                            </span>
                                        </a>
                                    </li>
                                    @if (getWebConfig(name: 'product_wise_shipping_cost_approval')==1)
                                        <li class="nav-item {{Request::is('admin/products/'.Product::UPDATED_PRODUCT_LIST[URI])?'active':''}}">
                                            <a class="nav-link text-capitalize" title="{{translate('product_update_requests')}}"
                                               href="{{route('admin.magzineproducts.updated-product-list')}}">
                                                <span class="tio-circle nav-indicator-icon"></span>
                                                <span class="text-truncate text-capitalize">{{Str::limit(translate('product_update_requests'), 18, '...')}}
                                                    <span class="badge badge-soft-info badge-pill ml-1">
                                                        {{getVendorProductsCount('product-updated-request')}}
                                    ...
                                    @endif
                                    <li class="nav-item {{str_contains(url()->current().'?status='.request()->get('status'),'/admin/products/'.Product::LIST[URI].'/magzineseller?status=1')==1?'active':''}}">
                                        <a class="nav-link"
                                           title="{{translate('approved_Products')}}"
                                           href="{{route('admin.magzineproducts.list',['magzineseller', 'status'=>'1'])}}">
                                            <span class="tio-circle nav-indicator-icon"></span>
                                            <span class="text-truncate">{{translate('approved_Products')}}
                                                 <span class="badge badge-soft-success badge-pill ml-1">
                                                    {{getMagzineVendorProductsCount('approved')}}
                                                </span>
                                            </span>
                                        </a>
                                    </li>
                                    <li class="nav-item {{str_contains(url()->current().'?status='.request()->get('status'),'/admin/products/'.Product::LIST[URI].'/magzineseller?status=2')==1?'active':''}}">
                                        <a class="nav-link"
                                           title="{{translate('denied_Products')}}"
                                           href="{{route('admin.magzineproducts.list',['magzineseller', 'status'=>'2'])}}">
                                            <span class="tio-circle nav-indicator-icon"></span>
                                            <span class="text-truncate">{{translate('denied_Products')}}
                                                <span class="badge badge-soft-danger badge-pill ml-1">
                                                    {{getMagzineVendorProductsCount('denied')}}
                                                </span>
                                            </span>
                                        </a>
                                    </li>
 ...
 <li class="navbar-vertical-aside-has-menu {{Request::is('admin/prime*')?'active':''}}">
                                <a class="js-navbar-vertical-aside-menu-link nav-link"
                                   href="{{route('admin.prime.list')}}" title="{{'Prime Subscription'}}">
                                    <i class="tio-photo-square-outlined nav-icon"></i>
                                    <span
                                        class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">{{'Prime Subscription'}}</span>
                                </a>
                            </li>


                            <li style="display:none" class="navbar-vertical-aside-has-menu {{(Request::is('admin/coupon*') || Request::is('admin/deal*')) ?'active':''}}">
                                <a class="js-navbar-vertical-aside-menu-link nav-link nav-link-toggle"
                            ...
                            <li style="display:none" class="navbar-vertical-aside-has-menu {{Request::is('admin/notification*') ||  Request::is('admin/push-notification/*')  ?'active':''}}">
                                <a class="js-navbar-vertical-aside-menu-link nav-link nav-link-toggle"
                            ...
                            <li style="display:none" class="navbar-vertical-aside-has-menu {{Request::is('admin/business-settings/'.BusinessSettings::ANNOUNCEMENT[URI])?'active':''}}">
                                <a class="js-navbar-vertical-aside-menu-link nav-link"
                        ...
                        @if(Helpers::module_permission_check('support_section'))
                            <li style="display:none" class="nav-item {{(Request::is('admin/support-ticket*') || Request::is('admin/contact*'))?'scroll-here':''}}">
                                <small class="nav-subtitle"
                                       title="">{{translate('help_&_support')}}</small>
                                <small class="tio-more-horizontal nav-subtitle-replacer"></small>
                            </li>
                            <li style="display:none" class="navbar-vertical-aside-has-menu {{Request::is('admin/messages*')?'active':''}}">
                                <a class="nav-link"
                            ...
                            <li style="display:none"  class="navbar-vertical-aside-has-menu {{Request::is('admin/contact*')?'active':''}}">
                                <a class="js-navbar-vertical-aside-menu-link nav-link"
                        ...
                        @if(Helpers::module_permission_check('user_section'))
                            ...
                            <li class="navbar-vertical-aside-has-menu {{(Request::is('admin/customer/wallet*') || Request::is('admin/customer/'.Customer::LIST[URI]) || Request::is('admin/customer/'.Customer::VIEW[URI].'*') || Request::is('admin/reviews*') || Request::is('admin/customer/loyalty/'.Customer::LOYALTY_REPORT[URI]))?'active':''}}">
                                ...
                                <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
                                  ...
                                  <li class="nav-item ">
                                        <a class="nav-link " href="{{route('admin.primemember.list')}}"
                                           title="{{'Prime Member List'}}">
                                            <span class="tio-circle nav-indicator-icon"></span>
                                            <span class="text-truncate">{{'Prime Member List'}} </span>
                                        </a>
                                    </li>
                                    ...
                                    <li style="display: none;" class="nav-item {{Request::is('admin/customer/wallet/'.CustomerWallet::REPORT[URI])?'active':''}}">
                                    ...
                                    <li style="display: none;" class="nav-item {{Request::is('admin/customer/wallet/'.CustomerWallet::BONUS_SETUP[URI])?'active':''}}">
                                    ...
                                    <li style="display: none;" class="nav-item {{Request::is('admin/customer/loyalty/'.Customer::LOYALTY_REPORT[URI])?'active':''}}">
                            ...
                            <li class="navbar-vertical-aside-has-menu {{ Request::is('admin/seller*') || Request::is('admin/sellers/withdraw-method/*') ? 'active' : '' }}">
                                ...
                                <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
                                    ...
                                    <li style="display:none" class="nav-item {{Request::is('admin/sellers/'.Vendor::ADD[URI])?'active':''}}">
                                    ...
                                    <li class="nav-item {{Request::is('admin/sellers/'.Vendor::LIST[URI]) ||Request::is('admin/sellers/'.Vendor::VIEW[URI].'*') ?'active':''}}">
                                     ...
                                     <li class="nav-item {{Request::is('admin/magzinesellers/'.Vendor::LIST[URI]) ||Request::is('admin/magzinesellers/'.Vendor::VIEW[URI].'*') ?'active':''}}">
                                        <a class="nav-link" title="{{translate('vendor_List')}}"
                                           href="{{route('admin.magzinesellers.seller-list')}}">
                                            <span class="tio-circle nav-indicator-icon"></span>
                                            <span class="text-truncate">
                                        {{'Magzine vendor List'}}
                                    </span>
                                     ...
                                     <li class="nav-item {{Request::is('admin/handmadesellers/'.Vendor::LIST[URI]) ||Request::is('admin/handmadesellers/'.Vendor::VIEW[URI].'*') ?'active':''}}">
                                        <a class="nav-link" title="{{translate('vendor_List')}}"
                                           href="{{route('admin.handmadesellers.seller-list')}}">
                                            <span class="tio-circle nav-indicator-icon"></span>
                                            <span class="text-truncate">
                                        {{'Handmade vendor List'}}
                                    </span>
                                        </a>
                                    </li>
                                    <li style="display: none;" class="nav-item {{Request::is('admin/sellers/'.Vendor::WITHDRAW_LIST[URI])?'active':''}}">
                                    ...
                                    <li style="display: none;" class="nav-item {{(Request::is('admin/sellers/withdraw-method/*'))?'active':''}}">
                            ...
                            <li style="display:none" class="navbar-vertical-aside-has-menu {{Request::is('admin/delivery-man*')?'active':''}}">
                            ...
                            @if(auth('admin')->user()->admin_role_id==1)
                                <li style="display:none" class="navbar-vertical-aside-has-menu {{(Request::is('admin/employee*') || Request::is('admin/custom-role*'))?'active':''}}">
                                    <a class="js-navbar-vertical-aside-menu-link nav-link nav-link-toggle"
                            ...
                            <li style="display:none" class="navbar-vertical-aside-has-menu {{Request::is('admin/customer/'.Customer::SUBSCRIBER_LIST[URI])?'active':''}}">
                        ...
                        @if(Helpers::module_permission_check('system_settings'))
                            ...
                            <li class="navbar-vertical-aside-has-menu">
                                ...
                                <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
                                    ...
                                    <li style="display: none;" class="nav-item {{Request::is('admin/product-settings/'.InhouseShop::VIEW[URI]) ? 'active' : ''}}">
                            ...
                            <li class="navbar-vertical-aside-has-menu {{ (
                                ...
                                <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
                                    ...
                                    <li style="display: none;" class="navbar-vertical-aside-has-menu {{Request::is('admin/file-manager*')?'active':''}}">
                                        <a class="js-navbar-vertical-aside-menu-link nav-link"
                            ...
                            <li  style="display:none" class="navbar-vertical-aside-has-menu {{ Request::is('admin/react')?'active':'' }}">
