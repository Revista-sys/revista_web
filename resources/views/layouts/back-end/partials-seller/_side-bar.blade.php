    ...
    <aside style="text-align: {{Session::get('direction') === "rtl" ? 'right' : 'left'}};"
        ...
        <div class="navbar-vertical-container">
            <div class="navbar-vertical-footer-offset pb-0">
                ...
                <div class="navbar-vertical-content test ajay">
                    ...
                    <ul class="navbar-nav navbar-nav-lg nav-tabs">
                        ...
                        @if ($sellerPOS == 1 && $seller['pos_status'] == 1)
                            <li style="display:none" class="navbar-vertical-aside-has-menu {{Request::is('vendor/pos*')?'active':''}}">
                                <a class="js-navbar-vertical-aside-menu-link nav-link"
                        ...
                        <li class="navbar-vertical-aside-has-menu {{Request::is('vendor/orders*')?'active':''}}">
                            ...
                            <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
                                ...
                                <li style="display: none;" class="nav-item {{Request::is('vendor/orders/'.OrderEnum::LIST[URI].'/processing')?'active':''}}">
                                ...
                                <li style="display: none;" class="nav-item {{Request::is('vendor/orders/'.OrderEnum::LIST[URI].'/out_for_delivery')?'active':''}}">
                                ...
                                <li style="display: none;" class="nav-item {{Request::is('vendor/orders/'.OrderEnum::LIST[URI].'/returned')?'active':''}}">
                                ...
                                <li style="display: none;" class="nav-item {{Request::is('vendor/orders/'.OrderEnum::LIST[URI].'/failed')?'active':''}}">
                        ...
                        <li style="display: none;" class="navbar-vertical-aside-has-menu {{Request::is('vendor/refund*')?'active':''}}">
...
?>
 ...
 @if(isset($vendor) && $vendor->seller_type==1 && $vendor->doc_image_approval_status == 0)
 ...
 <li class="nav-item">
                                    <a class="nav-link " href="{{ route('vendor.profile.update', ['id' => $vendor->id]) }}">
                                        <span class="tio-circle nav-indicator-icon"></span>
                                        <span class="text-truncate">{{'Manage Your Documents'}}</span>
                                    </a>
...
@elseif(isset($vendor) && $vendor->seller_type==2 && $vendor->doc_image_approval_status == 0)
 ...
 <li class="nav-item">
  ...
  @endif
                                ...
                                @if(isset($vendor) && $vendor->seller_type==1 && $vendor->doc_image_approval_status == 1 )
 ...
 <li class="nav-item {{Request::is('vendor/products/'.Product::LIST[URI].'/approved')?'active':''}}">
                                ...
                                <li class="sellettype1 nav-item  

 {{Request::is('vendor/products/'.Product::ADD[URI])?'active':''}}">
                                ...
                                <li style="display:none" class="nav-item {{Request::is('vendor/products/'.Product::BULK_IMPORT[URI]) ? 'active':''}}">
                                    <a class="nav-link " href="{{route('vendor.products.bulk-import')}}">
                                        ...
                                        @elseif(isset($vendor) && ($vendor->seller_type==2 ) && $vendor->doc_image_approval_status == 1)
                                ...
                                <li style="display:none" class="nav-item {{Request::is('vendor/products/'.Product::BULK_IMPORT[URI]) ? 'active':''}}">
                                    <a class="nav-link " href="{{route('vendor.products.bulk-import')}}">
                                        ...
                                        <span class="text-truncate">{{translate('bulk_import')}}</span>
                                           ...
                                           @elseif(isset($vendor) && $vendor->seller_type==3)
                                ...
                                <li class="nav-item {{Request::is('vendor/products/'.Product::LIST[URI].'/denied')?'active':''}}">
                                    <a class="nav-link " href="{{route('vendor.products.list',['type'=>'denied'])}}">
                                        ...
                                        <span class="text-truncate text-capitalize">{{translate('denied_product_request')}}</span>
                                             ...
                                             <li class="nav-item {{Request::is('vendor/magzineproducts/'.Product::LIST[URI].'/all')|| Request::is('vendor/magzineproducts/'.Product::UPDATE[URI].'*')||   Request::is('vendor/magzineproducts/'.Product::VIEW[URI].'*') || Request::is('vendor/magzineproducts/'.Product::STOCK_LIMIT[URI])?'active':''}}">
                                    <a class="nav-link " href="{{route('vendor.magzineproducts.list',['type'=>'all'])}}">
                                        <span class="tio-circle nav-indicator-icon"></span>
                                        <span class="text-truncate text-capitalize">{{translate('product_list')}}</span>
                                    </a>
                                </li>
                                <li class="sellettype3 nav-item  
     
 {{Request::is('vendor/magzineproducts/'.Product::ADD[URI])?'active':''}}">
                                    <a class="nav-link " href="{{route('vendor.magzineproducts.add')}}">
                                        <span class="tio-circle nav-indicator-icon"></span>
                                        <span
                                            class="text-truncate text-capitalize">{{translate('add_new_product')}}</span>
                                    </a>
                        ...
                        <li style="display: none;" class="navbar-vertical-aside-has-menu {{Request::is('vendor/reviews/'.Review::INDEX[URI].'*')?'active':''}}">
                            <a class="js-navbar-vertical-aside-menu-link nav-link"
                        ...
                        <li style="display: none;" class="navbar-vertical-aside-has-menu {{Request::is('vendor/coupon*')?'active':''}}">
                            <a class="nav-link"
                        ...
                        <li  style="display: none;"class="navbar-vertical-aside-has-menu {{Request::is('vendor/messages*')?'active':''}}">
                            <a class="nav-link"
                        ...
                        @endif
                        <li style="display: none;" class="navbar-vertical-aside-has-menu {{Request::is('vendor/business-settings/withdraw*')?'active':''}}">
                            <a class="js-navbar-vertical-aside-menu-link nav-link"
                        ...
                        <li style="display: none;" class="navbar-vertical-aside-has-menu {{Request::is('vendor/profile/'.Profile::INDEX[URI]) || Request::is('vendor/profile/'.Profile::BANK_INFO_UPDATE[URI]) ?'active':''}}">
                            <a class="js-navbar-vertical-aside-menu-link nav-link"
                        ...
                        @if($shippingMethod=='sellerwise_shipping')
                            ...
                            <li style="display: none;" class="navbar-vertical-aside-has-menu {{Request::is('vendor/delivery-man*')?'active':''}}">
                                <a class="js-navbar-vertical-aside-menu-link nav-link nav-link-toggle"
                                   href="javascript:">
