    ...
    <div class="content container-fluid">
        <div class="mb-4">
            <h2 class="h1 mb-0 text-capitalize d-flex align-items-center gap-2">
                ...
                {{ $sellers[0]->seller_type!='' && $sellers[0]->seller_type==2?"Handmade":""}}     
                            ...
                            <div class="d-flex justify-content-end gap-2">
                                <div class="dropdown text-nowrap">
                                    ...
                                    <ul class="dropdown-menu dropdown-menu-right">
                                        <li>
                                            <a type="submit" class="dropdown-item d-flex align-items-center gap-2 " href="{{route('admin.handmadesellers.export',['searchValue' => request('searchValue')])}}">
                                ...
                                <a href="{{route('admin.handmadesellers.add')}}" type="button" class="btn btn--primary text-nowrap">
                                    <i class="tio-add"></i>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center gap-10 w-max-content">
                                            ...
                                            class="avatar rounded-circle" src="{{ getValidImage(path: 'storage/app/public/shop/'.($seller->shop?$seller->shop->image:''), type: 'backend-basic') }}"
                                                alt="">
                                            <div>
                                                <a class="title-color" href="{{ route('admin.handmadesellers.view', ['id' => $seller->id]) }}">{{ $seller->shop ? Str::limit($seller->shop->name, 20) : translate('shop_not_found')}}</a>
                                                <br>
                                    ...
                                    <td>
                                        <a title="{{translate('view')}}"
                                           class="title-color"
                                           href="{{route('admin.handmadesellers.view',$seller->id)}}">
                                    ...
                                    <td>
                                     ...
                                     <td>
                                      <img width="50"
                                            class="avatar rounded-circle" src="{{ getValidImage(path: 'storage/app/public/seller/'.($seller->freelancer?$seller->freelancer.'webp':''), type: 'backend-basic') }}"
                                                alt="">
                                    </td>
                                     ...
                                     <td>
                                      <a title="{{translate('view')}}"
                                           class="title-color"
                                           href="#">
                                            {{$seller->national_address}}
                                        </a>
                                    </td>
                                         <td>
                                        <img width="50"
                                            class="avatar rounded-circle" src="{{ getValidImage(path: 'storage/app/public/seller/'.($seller->iban?$seller->iban:''), type: 'backend-basic') }}"
                                                alt="">
                                    </td>

                                        <td>
                                        <img width="50"
                                            class="avatar rounded-circle" src="{{ getValidImage(path: 'storage/app/public/seller/'.($seller->vat?$seller->vat:''), type: 'backend-basic') }}"
                                                alt="">
                                    </td>

                                        <td>
                                        <img width="50"
                                            class="avatar rounded-circle" src="{{ getValidImage(path: 'storage/app/public/seller/'.($seller->fda?$seller->fda:''), type: 'backend-basic') }}"
                                                alt="">
                                    </td>
                                    <td class="text-center">
                                        <a href="{{route('admin.handmadesellers.product-list',[$seller['id']])}}"
                                           class="btn text--primary bg-soft--primary font-weight-bold px-3 py-1 mb-0 fz-12">
                                            {{$seller->product->count()}}
                                        </a>
                                    </td>
                                    <td class="text-center">
                                        <a href="{{route('admin.handmadesellers.order-list',[$seller['id']])}}"
