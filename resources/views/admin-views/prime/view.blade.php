            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <h5 class="mb-0 text-capitalize">{{ 'Plan Form' }}</h5>
                    </div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        <label for="resource_id"
                                               class="title-color text-capitalize">{{'Price' }}</label>
                        ...
                        <div class="row align-items-center">
                            <div class="col-md-4 col-lg-6 mb-2 mb-md-0">
                                <h5 class="mb-0 text-capitalize d-flex gap-2">
                                    {{ 'Plan Table' }}
                                    <span
                                        class="badge badge-soft-dark radius-50 fz-12">{{ $primes->total() }}</span>
                                </h5>
                            </div>
                    ...
                    <div class="table-responsive">
                        <table id="columnSearchDatatable"
                            ...
                            @foreach($primes as $key=>$prime)
                                <tbody>
                                <tr id="data-{{ $prime->id}}">
                                    <td class="pl-xl-5">{{ $primes->firstItem()+$key}}</td>
                                    <td>
                                        {{$prime->price }}
                                    </td>
                                    <td>{{$prime->name}}</td>
                                    ...
                                    <td>
                                         ...
                                         <div class="d-flex gap-10 justify-content-center">
                                            <a class="btn btn-outline--primary btn-sm cursor-pointer edit"
                                               ...
                                               href="{{ route('admin.prime.update',[$prime['id']]) }}">
                                                <i class="tio-edit"></i>
                                            </a>
                                            <a class="btn btn-outline-danger btn-sm cursor-pointer prime-delete-button" style="display:none"
