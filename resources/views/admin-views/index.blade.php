                ...
                <div class="card">
                    ...
                    <div class="table-responsive">
                        <table
                            ...
                            <tr>
                                <th>{{translate('SL')}}</th>
                                <th>{{translate('shop_name')}}{{'AJAY'}}</th>
                                ...
                                <tr>
                                    ...
                                    <td>
                                      ...
                                      <td>
                                                ...
                                                {!! $seller->doc_image_approval_status == 1 ? '<img width="50" class="avatar rounded-circle" src="' . getValidImage(path: 'storage/app/public/seller/'.($seller->doc_image ? $seller->doc_image : ''), type: 'backend-basic') . '" alt="">' : '' !!}

                                    </td>

                                      <td>
                                                  {!! $seller->doc_image_approval_status == 1 ? '<img width="50" class="avatar rounded-circle" src="' . getValidImage(path: 'storage/app/public/seller/'.($seller->doc_image1 ? $seller->doc_image1 : ''), type: 'backend-basic') . '" alt="">' : '' !!}
