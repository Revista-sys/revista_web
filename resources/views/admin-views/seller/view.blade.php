...
<img class="avatar docimg avatar-170 rounded-0"
...
@endif
 ...
 @if ($seller['status']=='approved' && $seller['doc_image_approval_status']==0 && ($seller['seller_type']==1))
                        <div class="d-flex justify-content-sm-end flex-wrap gap-2 mb-3">

                            <form class="d-inline-block" action="{{route('admin.sellers.updateDocStatus')}}" id="approve-form" method="POST">
                                @csrf
                                <input type="hidden" name="id" value="{{$seller['id']}}">
                    ...
                    <form class="d-inline-block" action="{{route('admin.sellers.updateCommissionStatus')}}" id="approve-form" method="POST">
                                @csrf
                                <input type="hidden" name="id" value="{{$seller['id']}}">

                    <div class="d-flex justify-content-sm-end flex-wrap gap-6 mb-12">
                    <div class="row form-group">
                                <label for="newNationalLabel"
                                       class="col-sm-3 col-form-label input-label">{{ 'Vendor Commission (%)' }}</label>
                                ...
                                <div class="bg-light p-3 border border-primary-light rounded">
                                    ...
                                    <div class="d-flex gap-5">
                                        <div class="pair-list">
                                            ...
                                            class="avatar docimg" src="{{ getValidImage(path: 'storage/app/public/seller/'.($seller->iban ? $seller->iban.'webp':''), type: 'backend-basic') }}"
                                                alt="">
                                            </div>
...
<div class="d-flex gap-5 pt-3">
 <div class="pair-list">
                                            ...
                                            <div>
                                                <span class="key text-nowrap" style="min-width: 150px;">{{'Commercial Registration'}}</span>
                                                <span class="px-2">:</span>
                                                <span class="value">{{$seller->commercial_registration ?? translate('no_data_found') }}</span>
                                            </div>
