...
@section('content')
    <div class="content container-fluid test">
        <div class="mb-4">
            <h2 class="h1 mb-0 text-capitalize d-flex align-items-center gap-2">
                <img src="{{dynamicAsset(path: 'public/assets/back-end/img/add-new-seller.png')}}" alt="">
                {{ $sellers[0]->seller_type!='' && $sellers[0]->seller_type==3?"Main":""}}     
                                    ...
                                    <td>
                                     ...
                                     <td>
                                      <a title="{{translate('view')}}"
                                         ...
                                         <td>
                                        <img width="50"
                                            class="avatar rounded-circle" src="{{ getValidImage(path: 'storage/app/public/seller/'.($seller->iban ? $seller->iban.'webp':''), type: 'backend-basic') }}"
                                                alt="">
                                    </td>

                                        <td>
                                        <img width="50"
                                            class="avatar rounded-circle" src="{{ getValidImage(path: 'storage/app/public/seller/'.($seller->vat ? $seller->vat.'webp':''), type: 'backend-basic') }}"
                                                alt="">
                                    </td>

                                        <td>
                                        <img width="50"
                                            class="avatar rounded-circle" src="{{ getValidImage(path: 'storage/app/public/seller/'.($seller->fda ? $seller->fda.'webp':''), type: 'backend-basic') }}"
                                                alt="">
                                    </td>
