                                        ...
                                        @foreach($languages as $lang)
                                            <div
                                                ...
                                                <input type="text" name="name[]" class="form-control"
                                                       ...
                                                       <label class="title-color">{{ translate('vendor_commission') }}<span
                                                        class="text-danger">*</span> ({{strtoupper($lang) }})</label>
                                                <input type="text" name="vendor_commission ⁠ []" class="form-control"
                                                       placeholder="{{ translate('vendor_commission') }}" {{ $lang == $defaultLanguage? 'required':''}}>
