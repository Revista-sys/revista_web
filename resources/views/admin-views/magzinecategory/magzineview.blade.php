...
@section('title', 'magzine category')
...
@section('content')
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-body text-start">
                        <form action="{{ route('admin.magzinecategory.store') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                                ...
                                <div class="col-lg-6">
                                  ...
                                  <div class="from_part_2" >
                                        ...
                                        <div class="custom-file text-left">
                                            <input type="file" name="image12" id="category-image"
                                    ...
                                    <ul class="dropdown-menu dropdown-menu-right">
                                        <li>
                                            <a class="dropdown-item"
                                               href="{{ route('admin.magzinecategory.export',['searchValue'=>request('searchValue')]) }}">
                    ...
                    <div class="table-responsive">
                        <table
                            ...
                            <tr>
                                ...
                                <th class="text-center" style="display:none">{{ translate('priority') }}</th>
                            ...
                            @foreach($categories as $key=>$category)
                                <tr>
                                    ...
                                    <td class="text-center">
                                        ...
                                        <form action="{{ route('admin.magzinecategory.status') }}" method="post"
                                    ...
                                    <td>
                                        <div class="d-flex justify-content-center gap-10">
                                            <a class="btn btn-outline-info btn-sm square-btn "
                                               ...
                                               href="{{ route('admin.magzinecategory.update',[$category['id']]) }}">
                                                <i class="tio-edit"></i>
                                            </a>
    ...
    <span id="route-admin-category-delete" data-url="{{ route('admin.magzinecategory.delete') }}"></span>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content shadow-lg">
                ...
                <div class="modal-body px-4 px-sm-5 pt-0 pb-sm-5">
                    ...
                    <form action="{{ route('admin.magzinecategory.delete') }}" method="post" class="product-category-update-form-submit">
                        @csrf
