...
@section('content')
    <div class="content container-fluid test12">
        <div class="mb-4">
           ...
           {{ $sellers[0]->seller_type!='' && $sellers[0]->seller_type==3?"Magzine":""}}     {{translate('vendor_List')}}
                            ...
                            <div class="d-flex justify-content-end gap-2">
                                <div class="dropdown text-nowrap">
                                    ...
                                    <ul class="dropdown-menu dropdown-menu-right">
                                        <li>
                                            <a type="submit" class="dropdown-item d-flex align-items-center gap-2 " href="{{route('admin.magzinesellers.export',['searchValue' => request('searchValue')])}}">
                                ...
                                <a href="{{route('admin.magzinesellers.add')}}" type="button" class="btn btn--primary text-nowrap">
                                    <i class="tio-add"></i>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center gap-10 w-max-content">
                                            ...
                                            class="avatar rounded-circle" src="{{ getValidImage(path: 'storage/app/public/shop/'.($seller->shop?$seller->shop->image:''), type: 'backend-basic') }}"
                                                alt="">
                                            <div>
                                                <a class="title-color" href="{{ route('admin.magzinesellers.view', ['id' => $seller->id]) }}">{{ $seller->shop ? Str::limit($seller->shop->name, 20) : translate('shop_not_found')}}</a>
                                                <br>
                                    ...
                                    <td>
                                        <a title="{{translate('view')}}"
                                           class="title-color"
                                           href="{{route('admin.magzinesellers.view',$seller->id)}}">
                                    ...
                                    <td>
                                       ...
                                       <!--   <td>
                                        {!! $seller->doc_image_approval_status==1?'<label class="badge badge-success">'.translate('active').'</label>':'<label class="badge badge-danger">'.translate('inactive').'</label>' !!}
                                    </td> -->

                                   <!--    <td>
                                      

                                                {!! $seller->status == 'approved' ? '<img width="50" class="avatar rounded-circle" src="' . getValidImage(path: 'storage/app/public/seller/'.($seller->doc_image ? $seller->doc_image : ''), type: 'backend-basic') . '" alt="">' : '' !!}

                                    </td> -->

                                     <!--  <td>
                                                  {!! $seller->status == 'approved' ? '<img width="50" class="avatar rounded-circle" src="' . getValidImage(path: 'storage/app/public/seller/'.($seller->doc_image1 ? $seller->doc_image1 : ''), type: 'backend-basic') . '" alt="">' : '' !!}

                                    </td> -->
                                    <td class="text-center">
                                        <a href="{{route('admin.magzinesellers.product-list',[$seller['id']])}}"
                                           class="btn text--primary bg-soft--primary font-weight-bold px-3 py-1 mb-0 fz-12">
                                            {{$seller->product->count()}}
                                        </a>
                                    </td>
                                    <td class="text-center">
                                        <a href="{{route('admin.magzinesellers.order-list',[$seller['id']])}}"
