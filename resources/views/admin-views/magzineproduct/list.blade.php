                    ...
                    <div class="row gx-2">
                        ...
                        <div class="col-12">
                            <div class="d-flex gap-3 justify-content-end">
                                <a href="{{ route('admin.magzineproducts.list',['type'=>request('type')]) }}"
                    ...
                    <div class="px-3 py-4">
                        <div class="row align-items-center">
                            ...
                            <div class="col-lg-8 mt-3 mt-lg-0 d-flex flex-wrap gap-3 justify-content-lg-end">
                                ...
                                <div>
                                    <button  style="display:none" type="button" class="btn btn-outline--primary" data-toggle="dropdown">
                                    ...
                                    <ul class="dropdown-menu dropdown-menu-right">
                                        <li>
                                            <a class="dropdown-item"
                                               href="{{ route('admin.magzineproducts.export-excel',['type'=>request('type')]) }}?brand_id={{request('brand_id') }}&searchValue={{ request('searchValue') }}&category_id={{request('category_id') }}&sub_category_id={{request('sub_category_id') }}&sub_sub_category_id={{request('sub_sub_category_id') }}&seller_id={{request('seller_id') }}&status={{request('status') }}">
                                ...
                                @if($type == 'in_house')
                                    <a href="{{ route('admin.magzineproducts.stock-limit-list',['in_house']) }}"
                                       class="btn btn-info">
                                        <span class="text">{{ translate('limited_Stocks') }}</span>
                                    </a>
                                    <a href="{{ route('admin.magzineproducts.add') }}" class="btn btn--primary">
                                        <i class="tio-add"></i>
                    ...
                    <div class="table-responsive">
                        <table id="datatable"
                            ...
                            <tr>
                                ...
                                <th class="text-center" style="display: none">{{ translate('product Type') }}</th>
                                <th class="text-center">{{ translate('unit_price') }}</th>
                                <th class="text-center">{{ 'start date' }}</th>
                                <th class="text-center">{{ 'end date' }}</th>
                                <th class="text-center" style="display: none;">{{ translate('show_as_featured') }}</th>
                            ...
                            @foreach($products as $key=>$product)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('admin.magzineproducts.view',['addedBy'=>$product['added_by'],'id'=>$product['id']]) }}"
                                    ...
                                    <td class="text-center">
                                        {{$product['magzine_start_date']}}
                                    </td>
                                    <td class="text-center">
                                        {{$product['magzine_end_date']}}
                                    </td>
                                    <td class="text-center" style="display:none">

                                        @php($productName = str_replace("'",'`',$product['name']))
                                        <form action="{{ route('admin.magzineproducts.featured-status') }}" method="post"
                                    ...
                                    <td class="text-center">
                                        <form action="{{ route('admin.magzineproducts.status-update') }}" method="post" data-from="product-status"
                                    ...
                                    <td>
                                        <div class="d-flex justify-content-center gap-2">
                                            <a style="display:none" class="btn btn-outline-info btn-sm square-btn"
                                               title="{{ translate('barcode') }}"
                                               href="{{ route('admin.magzineproducts.barcode', [$product['id']]) }}">
                                                <i class="tio-barcode"></i>
                                            </a>
                                            <a class="btn btn-outline-info btn-sm square-btn" title="View"
                                               href="{{ route('admin.magzineproducts.view',['addedBy'=>$product['added_by'],'id'=>$product['id']]) }}">
                                                <i class="tio-invisible"></i>
                                            </a>
                                            <a class="btn btn-outline--primary btn-sm square-btn"
                                               title="{{ translate('edit') }}"
                                               href="{{ route('admin.magzineproducts.update',[$product['id']]) }}">
                                                <i class="tio-edit"></i>
                                            </a>
                                        ...
                                        <form action="{{ route('admin.magzineproducts.delete',[$product['id']]) }}"
