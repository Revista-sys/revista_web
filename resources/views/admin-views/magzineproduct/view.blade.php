...
@section('content')
                                        ...
                                        <div>
                                            @if($product['request_status'] == 0)
                                                <button class="btn btn-success p-2 px-3 update-status"
                                                   data-id="{{ $product['id'] }}"
                                                   data-redirect-route="{{route('admin.magzineproducts.list',['seller', 'status' => $product['request_status']])}}"
    ...
    <div class="modal fade" id="publishNoteModal" tabindex="-1" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form class="form-group" action="{{ route('admin.magzineproducts.deny', ['id'=>$product['id']]) }}"
    ...
    <span id="get-update-status-route" data-action="{{ route('admin.magzineproducts.approve-status')}}"></span>
@endsection
@push('script')
<script>
    'use strict';
