...
@section('content')
    <div class="content container-fluid">
        ...
        <form class="product-form text-start" action="{{ route('admin.magzineproducts.store') }}" method="POST"
            ...
            <div class="card mt-3 rest-part">
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-6 col-lg-4 col-xl-3">
                            <div class="form-group">
                                ...
                                <select class="js-select2-custom form-control action-get-request-onchange" name="category_id"
                                        data-url-prefix="{{ url('/admin/magzineproducts/get-categories?parent_id=') }}"
                        ...
                        <div style="display:none" class="col-md-6 col-lg-4 col-xl-3 physical_product_show">
                            <div class="form-group">
