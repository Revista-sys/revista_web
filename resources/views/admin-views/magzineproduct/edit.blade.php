...
@section('content')
    <div class="content container-fluid">
        ...
        <form class="product-form text-start" action="{{ route('admin.magzineproducts.update',$product->id) }}" method="post"
...
<input type="hidden" name="from_admin" value="1">
                <div class="card-body">
                    <div class="row align-items-end">
                        ...
                        <div style="display: none;" class="col-md-6 col-lg-4 col-xl-3" id="minimum_order_qty">
                            <div class="form-group">
                                <div class="d-flex gap-2">
                        ...
                        <div  style="display: none;" class="col-md-6 col-lg-4 col-xl-3 physical_product_show" id="quantity">
                            <div class="form-group" style="display: none;">
                                <div class="d-flex gap-2">
                                    <label class="title-color"
                        ...
                        <div  style="display: none;" class="col-md-6 col-lg-4 col-xl-3">
                            <div class="form-group">
                                <div class="d-flex gap-2">
                                    <label class="title-color"
                        ...
                        <div style="display: none;" class="col-md-6 col-lg-4 col-xl-3 physical_product_show" id="shipping_cost">
                            <div class="form-group" style="display: none;">
                                <div class="d-flex gap-2">
                        ...
                        <div style="display: none;" class="col-md-6 physical_product_show" id="shipping_cost_multy">
                            <div class="form-group" style="display: none;">
                                <div
